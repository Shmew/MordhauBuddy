...
module rec Electron =
    ...
    type App =
        ...
        /// details.
        [<Emit"$0.on('accessibility-support-changed',$1)">]
        abstract onAccessibilitySupportChanged : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.once('accessibility-support-changed',$1)">]
        abstract onceAccessibilitySupportChanged : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.addListener('accessibility-support-changed',$1)">]
        abstract addListenerAccessibilitySupportChanged : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.removeListener('accessibility-support-changed',$1)">]
        abstract removeListenerAccessibilitySupportChanged : listener:(Event -> bool -> unit) -> App

        /// Emitted when the application is activated. Various actions can trigger this
        /// event, such as launching the application for the first time, attempting to
        /// re-launch the application when it's already running, or clicking on the
        /// application's dock or taskbar icon.
        [<Emit"$0.on('activate',$1)">]
        abstract onActivate : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.once('activate',$1)">]
        abstract onceActivate : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.addListener('activate',$1)">]
        abstract addListenerActivate : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.removeListener('activate',$1)">]
        abstract removeListenerActivate : listener:(Event -> bool -> unit) -> App

        /// Emitted during Handoff after an activity from this device was successfully
        /// resumed on another one.
        [<Emit"$0.on('activity-was-continued',$1)">]
        abstract onActivityWasContinued : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.once('activity-was-continued',$1)">]
        abstract onceActivityWasContinued : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.addListener('activity-was-continued',$1)">]
        abstract addListenerActivityWasContinued : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.removeListener('activity-was-continued',$1)">]
        abstract removeListenerActivityWasContinued : listener:(Event -> string -> obj option -> unit) -> App
        ...
        /// logout.
        [<Emit"$0.on('before-quit',$1)">]
        abstract onBeforeQuit : listener:(Event -> unit) -> App

        [<Emit"$0.once('before-quit',$1)">]
        abstract onceBeforeQuit : listener:(Event -> unit) -> App

        [<Emit"$0.addListener('before-quit',$1)">]
        abstract addListenerBeforeQuit : listener:(Event -> unit) -> App

        [<Emit"$0.removeListener('before-quit',$1)">]
        abstract removeListenerBeforeQuit : listener:(Event -> unit) -> App

        /// Emitted when a browserWindow gets blurred.
        [<Emit"$0.on('browser-window-blur',$1)">]
        abstract onBrowserWindowBlur : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.once('browser-window-blur',$1)">]
        abstract onceBrowserWindowBlur : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.addListener('browser-window-blur',$1)">]
        abstract addListenerBrowserWindowBlur : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.removeListener('browser-window-blur',$1)">]
        abstract removeListenerBrowserWindowBlur : listener:(Event -> BrowserWindow -> unit) -> App

        /// Emitted when a new browserWindow is created.
        [<Emit"$0.on('browser-window-created',$1)">]
        abstract onBrowserWindowCreated : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.once('browser-window-created',$1)">]
        abstract onceBrowserWindowCreated : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.addListener('browser-window-created',$1)">]
        abstract addListenerBrowserWindowCreated : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.removeListener('browser-window-created',$1)">]
        abstract removeListenerBrowserWindowCreated : listener:(Event -> BrowserWindow -> unit) -> App

        /// Emitted when a browserWindow gets focused.
        [<Emit"$0.on('browser-window-focus',$1)">]
        abstract onBrowserWindowFocus : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.once('browser-window-focus',$1)">]
        abstract onceBrowserWindowFocus : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.addListener('browser-window-focus',$1)">]
        abstract addListenerBrowserWindowFocus : listener:(Event -> BrowserWindow -> unit) -> App

        [<Emit"$0.removeListener('browser-window-focus',$1)">]
        abstract removeListenerBrowserWindowFocus : listener:(Event -> BrowserWindow -> unit) -> App
        ...
        abstract onCertificateError : listener:(Event -> WebContents -> string -> string -> Certificate -> (bool -> unit) -> unit)
         -> App

        [<Emit"$0.once('certificate-error',$1)">]
        abstract onceCertificateError : listener:(Event -> WebContents -> string -> string -> Certificate -> (bool -> unit) -> unit)
         -> App

        [<Emit"$0.addListener('certificate-error',$1)">]
        abstract addListenerCertificateError : listener:(Event -> WebContents -> string -> string -> Certificate -> (bool -> unit) -> unit)
         -> App

        [<Emit"$0.removeListener('certificate-error',$1)">]
        abstract removeListenerCertificateError : listener:(Event -> WebContents -> string -> string -> Certificate -> (bool -> unit) -> unit)
         -> App
        ...
        [<Emit"$0.on('continue-activity',$1)">]
        abstract onContinueActivity : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.once('continue-activity',$1)">]
        abstract onceContinueActivity : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.addListener('continue-activity',$1)">]
        abstract addListenerContinueActivity : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.removeListener('continue-activity',$1)">]
        abstract removeListenerContinueActivity : listener:(Event -> string -> obj option -> unit) -> App

        /// Emitted during Handoff when an activity from a different device fails to be
        /// resumed.
        [<Emit"$0.on('continue-activity-error',$1)">]
        abstract onContinueActivityError : listener:(Event -> string -> string -> unit) -> App

        [<Emit"$0.once('continue-activity-error',$1)">]
        abstract onceContinueActivityError : listener:(Event -> string -> string -> unit) -> App

        [<Emit"$0.addListener('continue-activity-error',$1)">]
        abstract addListenerContinueActivityError : listener:(Event -> string -> string -> unit) -> App

        [<Emit"$0.removeListener('continue-activity-error',$1)">]
        abstract removeListenerContinueActivityError : listener:(Event -> string -> string -> unit) -> App
        ...
        [<Emit"$0.on('desktop-capturer-get-sources',$1)">]
        abstract onDesktopCapturerGetSources : listener:(Event -> WebContents -> unit) -> App

        [<Emit"$0.once('desktop-capturer-get-sources',$1)">]
        abstract onceDesktopCapturerGetSources : listener:(Event -> WebContents -> unit) -> App

        [<Emit"$0.addListener('desktop-capturer-get-sources',$1)">]
        abstract addListenerDesktopCapturerGetSources : listener:(Event -> WebContents -> unit) -> App

        [<Emit"$0.removeListener('desktop-capturer-get-sources',$1)">]
        abstract removeListenerDesktopCapturerGetSources : listener:(Event -> WebContents -> unit) -> App

        /// Emitted when the gpu process crashes or is killed.
        [<Emit"$0.on('gpu-process-crashed',$1)">]
        abstract onGpuProcessCrashed : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.once('gpu-process-crashed',$1)">]
        abstract onceGpuProcessCrashed : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.addListener('gpu-process-crashed',$1)">]
        abstract addListenerGpuProcessCrashed : listener:(Event -> bool -> unit) -> App

        [<Emit"$0.removeListener('gpu-process-crashed',$1)">]
        abstract removeListenerGpuProcessCrashed : listener:(Event -> bool -> unit) -> App
        ...
        /// the credentials.
        [<Emit"$0.on('login',$1)">]
        abstract onLogin : listener:(Event -> WebContents -> LoginRequest -> AuthInfo -> (string -> string -> unit) -> unit)
         -> App

        [<Emit"$0.once('login',$1)">]
        abstract onceLogin : listener:(Event -> WebContents -> LoginRequest -> AuthInfo -> (string -> string -> unit) -> unit)
         -> App

        [<Emit"$0.addListener('login',$1)">]
        abstract addListenerLogin : listener:(Event -> WebContents -> LoginRequest -> AuthInfo -> (string -> string -> unit) -> unit)
         -> App

        [<Emit"$0.removeListener('login',$1)">]
        abstract removeListenerLogin : listener:(Event -> WebContents -> LoginRequest -> AuthInfo -> (string -> string -> unit) -> unit)
         -> App

        /// Emitted when the user clicks the native macOS new tab button. The new tab button
        /// is only visible if the current BrowserWindow has a tabbingIdentifier
        [<Emit"$0.on('new-window-for-tab',$1)">]
        abstract onNewWindowForTab : listener:(Event -> unit) -> App

        [<Emit"$0.once('new-window-for-tab',$1)">]
        abstract onceNewWindowForTab : listener:(Event -> unit) -> App

        [<Emit"$0.addListener('new-window-for-tab',$1)">]
        abstract addListenerNewWindowForTab : listener:(Event -> unit) -> App

        [<Emit"$0.removeListener('new-window-for-tab',$1)">]
        abstract removeListenerNewWindowForTab : listener:(Event -> unit) -> App
        ...
        [<Emit"$0.on('open-file',$1)">]
        abstract onOpenFile : listener:(Event -> string -> unit) -> App

        [<Emit"$0.once('open-file',$1)">]
        abstract onceOpenFile : listener:(Event -> string -> unit) -> App

        [<Emit"$0.addListener('open-file',$1)">]
        abstract addListenerOpenFile : listener:(Event -> string -> unit) -> App

        [<Emit"$0.removeListener('open-file',$1)">]
        abstract removeListenerOpenFile : listener:(Event -> string -> unit) -> App
        ...
        [<Emit"$0.on('open-url',$1)">]
        abstract onOpenUrl : listener:(Event -> string -> unit) -> App

        [<Emit"$0.once('open-url',$1)">]
        abstract onceOpenUrl : listener:(Event -> string -> unit) -> App

        [<Emit"$0.addListener('open-url',$1)">]
        abstract addListenerOpenUrl : listener:(Event -> string -> unit) -> App

        [<Emit"$0.removeListener('open-url',$1)">]
        abstract removeListenerOpenUrl : listener:(Event -> string -> unit) -> App
        ...
        /// user logout.
        [<Emit"$0.on('quit',$1)">]
        abstract onQuit : listener:(Event -> int -> unit) -> App

        [<Emit"$0.once('quit',$1)">]
        abstract onceQuit : listener:(Event -> int -> unit) -> App

        [<Emit"$0.addListener('quit',$1)">]
        abstract addListenerQuit : listener:(Event -> int -> unit) -> App

        [<Emit"$0.removeListener('quit',$1)">]
        abstract removeListenerQuit : listener:(Event -> int -> unit) -> App
        ...
        [<Emit"$0.on('ready',$1)">]
        abstract onReady : listener:(obj option -> unit) -> App

        [<Emit"$0.once('ready',$1)">]
        abstract onceReady : listener:(obj option -> unit) -> App

        [<Emit"$0.addListener('ready',$1)">]
        abstract addListenerReady : listener:(obj option -> unit) -> App

        [<Emit"$0.removeListener('ready',$1)">]
        abstract removeListenerReady : listener:(obj option -> unit) -> App
        ...
        [<Emit"$0.on('remote-get-builtin',$1)">]
        abstract onRemoteGetBuiltin : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.once('remote-get-builtin',$1)">]
        abstract onceRemoteGetBuiltin : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.addListener('remote-get-builtin',$1)">]
        abstract addListenerRemoteGetBuiltin : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.removeListener('remote-get-builtin',$1)">]
        abstract removeListenerRemoteGetBuiltin : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App
        ...
        /// returned. Custom value can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-get-current-web-contents',$1)">]
        abstract onRemoteGetCurrentWebContents : listener:(ReturnValueEvent -> WebContents -> unit) -> App

        [<Emit"$0.once('remote-get-current-web-contents',$1)">]
        abstract onceRemoteGetCurrentWebContents : listener:(ReturnValueEvent -> WebContents -> unit) -> App

        [<Emit"$0.addListener('remote-get-current-web-contents',$1)">]
        abstract addListenerRemoteGetCurrentWebContents : listener:(ReturnValueEvent -> WebContents -> unit) -> App

        [<Emit"$0.removeListener('remote-get-current-web-contents',$1)">]
        abstract removeListenerRemoteGetCurrentWebContents : listener:(ReturnValueEvent -> WebContents -> unit) -> App

        /// Emitted when remote.getCurrentWindow() is called in the renderer process of
        /// webContents. Calling event.preventDefault() will prevent the object from being
        /// returned. Custom value can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-get-current-window',$1)">]
        abstract onRemoteGetCurrentWindow : listener:(ReturnValueEvent -> WebContents -> unit) -> App

        [<Emit"$0.once('remote-get-current-window',$1)">]
        abstract onceRemoteGetCurrentWindow : listener:(ReturnValueEvent -> WebContents -> unit) -> App

        [<Emit"$0.addListener('remote-get-current-window',$1)">]
        abstract addListenerRemoteGetCurrentWindow : listener:(ReturnValueEvent -> WebContents -> unit) -> App

        [<Emit"$0.removeListener('remote-get-current-window',$1)">]
        abstract removeListenerRemoteGetCurrentWindow : listener:(ReturnValueEvent -> WebContents -> unit) -> App
        ...
        /// returned. Custom value can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-get-global',$1)">]
        abstract onRemoteGetGlobal : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.once('remote-get-global',$1)">]
        abstract onceRemoteGetGlobal : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.addListener('remote-get-global',$1)">]
        abstract addListenerRemoteGetGlobal : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.removeListener('remote-get-global',$1)">]
        abstract removeListenerRemoteGetGlobal : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        /// Emitted when <webview>.getWebContents() is called in the renderer process of
        /// webContents. Calling event.preventDefault() will prevent the object from being
        /// returned. Custom value can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-get-guest-web-contents',$1)">]
        abstract onRemoteGetGuestWebContents : listener:(ReturnValueEvent -> WebContents -> WebContents -> unit) -> App

        [<Emit"$0.once('remote-get-guest-web-contents',$1)">]
        abstract onceRemoteGetGuestWebContents : listener:(ReturnValueEvent -> WebContents -> WebContents -> unit)
         -> App

        [<Emit"$0.addListener('remote-get-guest-web-contents',$1)">]
        abstract addListenerRemoteGetGuestWebContents : listener:(ReturnValueEvent -> WebContents -> WebContents -> unit)
         -> App

        [<Emit"$0.removeListener('remote-get-guest-web-contents',$1)">]
        abstract removeListenerRemoteGetGuestWebContents : listener:(ReturnValueEvent -> WebContents -> WebContents -> unit)
         -> App

        /// Emitted when remote.require() is called in the renderer process of webContents.
        /// Calling event.preventDefault() will prevent the module from being returned.
        /// Custom value can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-require',$1)">]
        abstract onRemoteRequire : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.once('remote-require',$1)">]
        abstract onceRemoteRequire : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.addListener('remote-require',$1)">]
        abstract addListenerRemoteRequire : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App

        [<Emit"$0.removeListener('remote-require',$1)">]
        abstract removeListenerRemoteRequire : listener:(ReturnValueEvent -> WebContents -> string -> unit) -> App
        ...
        [<Emit"$0.on('second-instance',$1)">]
        abstract onSecondInstance : listener:(Event -> string [] -> string -> unit) -> App

        [<Emit"$0.once('second-instance',$1)">]
        abstract onceSecondInstance : listener:(Event -> string [] -> string -> unit) -> App

        [<Emit"$0.addListener('second-instance',$1)">]
        abstract addListenerSecondInstance : listener:(Event -> string [] -> string -> unit) -> App

        [<Emit"$0.removeListener('second-instance',$1)">]
        abstract removeListenerSecondInstance : listener:(Event -> string [] -> string -> unit) -> App
        ...
        abstract onSelectClientCertificate : listener:(Event -> WebContents -> string -> Certificate [] -> (Certificate -> unit) -> unit)
         -> App

        [<Emit"$0.once('select-client-certificate',$1)">]
        abstract onceSelectClientCertificate : listener:(Event -> WebContents -> string -> Certificate [] -> (Certificate -> unit) -> unit)
         -> App

        [<Emit"$0.addListener('select-client-certificate',$1)">]
        abstract addListenerSelectClientCertificate : listener:(Event -> WebContents -> string -> Certificate [] -> (Certificate -> unit) -> unit)
         -> App

        [<Emit"$0.removeListener('select-client-certificate',$1)">]
        abstract removeListenerSelectClientCertificate : listener:(Event -> WebContents -> string -> Certificate [] -> (Certificate -> unit) -> unit)
         -> App

        /// Emitted when Electron has created a new session.
        [<Emit"$0.on('session-created',$1)">]
        abstract onSessionCreated : listener:(Session -> unit) -> App

        [<Emit"$0.once('session-created',$1)">]
        abstract onceSessionCreated : listener:(Session -> unit) -> App

        [<Emit"$0.addListener('session-created',$1)">]
        abstract addListenerSessionCreated : listener:(Session -> unit) -> App

        [<Emit"$0.removeListener('session-created',$1)">]
        abstract removeListenerSessionCreated : listener:(Session -> unit) -> App
        ...
        [<Emit"$0.on('update-activity-state',$1)">]
        abstract onUpdateActivityState : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.once('update-activity-state',$1)">]
        abstract onceUpdateActivityState : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.addListener('update-activity-state',$1)">]
        abstract addListenerUpdateActivityState : listener:(Event -> string -> obj option -> unit) -> App

        [<Emit"$0.removeListener('update-activity-state',$1)">]
        abstract removeListenerUpdateActivityState : listener:(Event -> string -> obj option -> unit) -> App

        /// Emitted when a new webContents is created.
        [<Emit"$0.on('web-contents-created',$1)">]
        abstract onWebContentsCreated : listener:(Event -> WebContents -> unit) -> App

        [<Emit"$0.once('web-contents-created',$1)">]
        abstract onceWebContentsCreated : listener:(Event -> WebContents -> unit) -> App

        [<Emit"$0.addListener('web-contents-created',$1)">]
        abstract addListenerWebContentsCreated : listener:(Event -> WebContents -> unit) -> App

        [<Emit"$0.removeListener('web-contents-created',$1)">]
        abstract removeListenerWebContentsCreated : listener:(Event -> WebContents -> unit) -> App

        /// Emitted during Handoff before an activity from a different device wants to be
        /// resumed. You should call event.preventDefault() if you want to handle this
        /// event.
        [<Emit"$0.on('will-continue-activity',$1)">]
        abstract onWillContinueActivity : listener:(Event -> string -> unit) -> App

        [<Emit"$0.once('will-continue-activity',$1)">]
        abstract onceWillContinueActivity : listener:(Event -> string -> unit) -> App

        [<Emit"$0.addListener('will-continue-activity',$1)">]
        abstract addListenerWillContinueActivity : listener:(Event -> string -> unit) -> App

        [<Emit"$0.removeListener('will-continue-activity',$1)">]
        abstract removeListenerWillContinueActivity : listener:(Event -> string -> unit) -> App
        ...
        [<Emit"$0.on('will-finish-launching',$1)">]
        abstract onWillFinishLaunching : listener:(Event -> unit) -> App

        [<Emit"$0.once('will-finish-launching',$1)">]
        abstract onceWillFinishLaunching : listener:(Event -> unit) -> App

        [<Emit"$0.addListener('will-finish-launching',$1)">]
        abstract addListenerWillFinishLaunching : listener:(Event -> unit) -> App

        [<Emit"$0.removeListener('will-finish-launching',$1)">]
        abstract removeListenerWillFinishLaunching : listener:(Event -> unit) -> App
        ...
        [<Emit"$0.on('will-quit',$1)">]
        abstract onWillQuit : listener:(Event -> unit) -> App

        [<Emit"$0.once('will-quit',$1)">]
        abstract onceWillQuit : listener:(Event -> unit) -> App

        [<Emit"$0.addListener('will-quit',$1)">]
        abstract addListenerWillQuit : listener:(Event -> unit) -> App

        [<Emit"$0.removeListener('will-quit',$1)">]
        abstract removeListenerWillQuit : listener:(Event -> unit) -> App
        ...
        [<Emit"$0.on('window-all-closed',$1)">]
        abstract onWindowAllClosed : listener:(Event -> unit) -> App

        [<Emit"$0.once('window-all-closed',$1)">]
        abstract onceWindowAllClosed : listener:(Event -> unit) -> App

        [<Emit"$0.addListener('window-all-closed',$1)">]
        abstract addListenerWindowAllClosed : listener:(Event -> unit) -> App

        [<Emit"$0.removeListener('window-all-closed',$1)">]
        abstract removeListenerWindowAllClosed : listener:(Event -> unit) -> App
    ...
    type AutoUpdater =
        ...
        /// before-quit.
        [<Emit"$0.on('before-quit-for-update',$1)">]
        abstract onBeforeQuitForUpdate : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.once('before-quit-for-update',$1)">]
        abstract onceBeforeQuitForUpdate : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.addListener('before-quit-for-update',$1)">]
        abstract addListenerBeforeQuitForUpdate : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.removeListener('before-quit-for-update',$1)">]
        abstract removeListenerBeforeQuitForUpdate : listener:(Event -> unit) -> AutoUpdater

        /// Emitted when checking if an update has started.
        [<Emit"$0.on('checking-for-update',$1)">]
        abstract onCheckingForUpdate : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.once('checking-for-update',$1)">]
        abstract onceCheckingForUpdate : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.addListener('checking-for-update',$1)">]
        abstract addListenerCheckingForUpdate : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.removeListener('checking-for-update',$1)">]
        abstract removeListenerCheckingForUpdate : listener:(Event -> unit) -> AutoUpdater

        /// Emitted when there is an error while updating.
        [<Emit"$0.on('error',$1)">]
        abstract onError : listener:(Error -> unit) -> AutoUpdater

        [<Emit"$0.once('error',$1)">]
        abstract onceError : listener:(Error -> unit) -> AutoUpdater

        [<Emit"$0.addListener('error',$1)">]
        abstract addListenerError : listener:(Error -> unit) -> AutoUpdater

        [<Emit"$0.removeListener('error',$1)">]
        abstract removeListenerError : listener:(Error -> unit) -> AutoUpdater

        /// Emitted when there is an available update. The update is downloaded
        /// automatically.
        [<Emit"$0.on('update-available',$1)">]
        abstract onUpdateAvailable : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.once('update-available',$1)">]
        abstract onceUpdateAvailable : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.addListener('update-available',$1)">]
        abstract addListenerUpdateAvailable : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.removeListener('update-available',$1)">]
        abstract removeListenerUpdateAvailable : listener:(Event -> unit) -> AutoUpdater
        ...
        /// application starts.
        [<Emit"$0.on('update-downloaded',$1)">]
        abstract onUpdateDownloaded : listener:(Event -> string -> string -> DateTime -> string -> unit) -> AutoUpdater

        [<Emit"$0.once('update-downloaded',$1)">]
        abstract onceUpdateDownloaded : listener:(Event -> string -> string -> DateTime -> string -> unit)
         -> AutoUpdater

        [<Emit"$0.addListener('update-downloaded',$1)">]
        abstract addListenerUpdateDownloaded : listener:(Event -> string -> string -> DateTime -> string -> unit)
         -> AutoUpdater

        [<Emit"$0.removeListener('update-downloaded',$1)">]
        abstract removeListenerUpdateDownloaded : listener:(Event -> string -> string -> DateTime -> string -> unit)
         -> AutoUpdater

        /// Emitted when there is no available update.
        [<Emit"$0.on('update-not-available',$1)">]
        abstract onUpdateNotAvailable : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.once('update-not-available',$1)">]
        abstract onceUpdateNotAvailable : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.addListener('update-not-available',$1)">]
        abstract addListenerUpdateNotAvailable : listener:(Event -> unit) -> AutoUpdater

        [<Emit"$0.removeListener('update-not-available',$1)">]
        abstract removeListenerUpdateNotAvailable : listener:(Event -> unit) -> AutoUpdater
    ...
    type BrowserViewStatic =
        ...
        [<EmitConstructor>]
        abstract Create : options:BrowserViewOptions -> BrowserView
    ...
    type BrowserWindow =
        ...
        abstract onAlwaysOnTopChanged : listener:(Event -> bool -> unit) -> BrowserWindow

        [<Emit"$0.once('always-on-top-changed',$1)">]
        abstract onceAlwaysOnTopChanged : listener:(Event -> bool -> unit) -> BrowserWindow

        [<Emit"$0.addListener('always-on-top-changed',$1)">]
        abstract addListenerAlwaysOnTopChanged : listener:(Event -> bool -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('always-on-top-changed',$1)">]
        abstract removeListenerAlwaysOnTopChanged : listener:(Event -> bool -> unit) -> BrowserWindow
        ...
        abstract onAppCommand : listener:(Event -> string -> unit) -> BrowserWindow

        [<Emit"$0.once('app-command',$1)">]
        abstract onceAppCommand : listener:(Event -> string -> unit) -> BrowserWindow

        [<Emit"$0.addListener('app-command',$1)">]
        abstract addListenerAppCommand : listener:(Event -> string -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('app-command',$1)">]
        abstract removeListenerAppCommand : listener:(Event -> string -> unit) -> BrowserWindow

        /// Emitted when the window loses focus.
        [<Emit"$0.on('blur',$1)">]
        abstract onBlur : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('blur',$1)">]
        abstract onceBlur : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('blur',$1)">]
        abstract addListenerBlur : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('blur',$1)">]
        abstract removeListenerBlur : listener:(Event -> unit) -> BrowserWindow
        ...
        [<Emit"$0.on('close',$1)">]
        abstract onClose : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('close',$1)">]
        abstract onceClose : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('close',$1)">]
        abstract addListenerClose : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('close',$1)">]
        abstract removeListenerClose : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window is closed. After you have received this event you should
        /// remove the reference to the window and avoid using it any more.
        [<Emit"$0.on('closed',$1)">]
        abstract onClosed : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('closed',$1)">]
        abstract onceClosed : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('closed',$1)">]
        abstract addListenerClosed : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('closed',$1)">]
        abstract removeListenerClosed : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window enters a full-screen state.
        [<Emit"$0.on('enter-full-screen',$1)">]
        abstract onEnterFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('enter-full-screen',$1)">]
        abstract onceEnterFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('enter-full-screen',$1)">]
        abstract addListenerEnterFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('enter-full-screen',$1)">]
        abstract removeListenerEnterFullScreen : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window enters a full-screen state triggered by HTML API.
        [<Emit"$0.on('enter-html-full-screen',$1)">]
        abstract onEnterHtmlFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('enter-html-full-screen',$1)">]
        abstract onceEnterHtmlFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('enter-html-full-screen',$1)">]
        abstract addListenerEnterHtmlFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('enter-html-full-screen',$1)">]
        abstract removeListenerEnterHtmlFullScreen : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window gains focus.
        [<Emit"$0.on('focus',$1)">]
        abstract onFocus : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('focus',$1)">]
        abstract onceFocus : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('focus',$1)">]
        abstract addListenerFocus : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('focus',$1)">]
        abstract removeListenerFocus : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window is hidden.
        [<Emit"$0.on('hide',$1)">]
        abstract onHide : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('hide',$1)">]
        abstract onceHide : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('hide',$1)">]
        abstract addListenerHide : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('hide',$1)">]
        abstract removeListenerHide : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window leaves a full-screen state.
        [<Emit"$0.on('leave-full-screen',$1)">]
        abstract onLeaveFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('leave-full-screen',$1)">]
        abstract onceLeaveFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('leave-full-screen',$1)">]
        abstract addListenerLeaveFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('leave-full-screen',$1)">]
        abstract removeListenerLeaveFullScreen : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window leaves a full-screen state triggered by HTML API.
        [<Emit"$0.on('leave-html-full-screen',$1)">]
        abstract onLeaveHtmlFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('leave-html-full-screen',$1)">]
        abstract onceLeaveHtmlFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('leave-html-full-screen',$1)">]
        abstract addListenerLeaveHtmlFullScreen : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('leave-html-full-screen',$1)">]
        abstract removeListenerLeaveHtmlFullScreen : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when window is maximized.
        [<Emit"$0.on('maximize',$1)">]
        abstract onMaximize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('maximize',$1)">]
        abstract onceMaximize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('maximize',$1)">]
        abstract addListenerMaximize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('maximize',$1)">]
        abstract removeListenerMaximize : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window is minimized.
        [<Emit"$0.on('minimize',$1)">]
        abstract onMinimize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('minimize',$1)">]
        abstract onceMinimize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('minimize',$1)">]
        abstract addListenerMinimize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('minimize',$1)">]
        abstract removeListenerMinimize : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window is being moved to a new position. Note: On macOS this
        /// event is an alias of moved.
        [<Emit"$0.on('move',$1)">]
        abstract onMove : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('move',$1)">]
        abstract onceMove : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('move',$1)">]
        abstract addListenerMove : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('move',$1)">]
        abstract removeListenerMove : listener:(Event -> unit) -> BrowserWindow

        /// Emitted once when the window is moved to a new position.
        [<Emit"$0.on('moved',$1)">]
        abstract onMoved : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('moved',$1)">]
        abstract onceMoved : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('moved',$1)">]
        abstract addListenerMoved : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('moved',$1)">]
        abstract removeListenerMoved : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the native new tab button is clicked.
        [<Emit"$0.on('new-window-for-tab',$1)">]
        abstract onNewWindowForTab : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('new-window-for-tab',$1)">]
        abstract onceNewWindowForTab : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('new-window-for-tab',$1)">]
        abstract addListenerNewWindowForTab : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('new-window-for-tab',$1)">]
        abstract removeListenerNewWindowForTab : listener:(Event -> unit) -> BrowserWindow
        ...
        abstract onPageTitleUpdated : listener:(Event -> string -> bool -> unit) -> BrowserWindow

        [<Emit"$0.once('page-title-updated',$1)">]
        abstract oncePageTitleUpdated : listener:(Event -> string -> bool -> unit) -> BrowserWindow

        [<Emit"$0.addListener('page-title-updated',$1)">]
        abstract addListenerPageTitleUpdated : listener:(Event -> string -> bool -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('page-title-updated',$1)">]
        abstract removeListenerPageTitleUpdated : listener:(Event -> string -> bool -> unit) -> BrowserWindow

        /// Emitted when the web page has been rendered (while not being shown) and window
        /// can be displayed without a visual flash.
        [<Emit"$0.on('ready-to-show',$1)">]
        abstract onReadyToShow : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('ready-to-show',$1)">]
        abstract onceReadyToShow : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('ready-to-show',$1)">]
        abstract addListenerReadyToShow : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('ready-to-show',$1)">]
        abstract removeListenerReadyToShow : listener:(Event -> unit) -> BrowserWindow

        /// Emitted after the window has been resized.
        [<Emit"$0.on('resize',$1)">]
        abstract onResize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('resize',$1)">]
        abstract onceResize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('resize',$1)">]
        abstract addListenerResize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('resize',$1)">]
        abstract removeListenerResize : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the unresponsive web page becomes responsive again.
        [<Emit"$0.on('responsive',$1)">]
        abstract onResponsive : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('responsive',$1)">]
        abstract onceResponsive : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('responsive',$1)">]
        abstract addListenerResponsive : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('responsive',$1)">]
        abstract removeListenerResponsive : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window is restored from a minimized state.
        [<Emit"$0.on('restore',$1)">]
        abstract onRestore : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('restore',$1)">]
        abstract onceRestore : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('restore',$1)">]
        abstract addListenerRestore : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('restore',$1)">]
        abstract removeListenerRestore : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when scroll wheel event phase has begun.
        [<Emit"$0.on('scroll-touch-begin',$1)">]
        abstract onScrollTouchBegin : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('scroll-touch-begin',$1)">]
        abstract onceScrollTouchBegin : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('scroll-touch-begin',$1)">]
        abstract addListenerScrollTouchBegin : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('scroll-touch-begin',$1)">]
        abstract removeListenerScrollTouchBegin : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when scroll wheel event phase filed upon reaching the edge of element.
        [<Emit"$0.on('scroll-touch-edge',$1)">]
        abstract onScrollTouchEdge : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('scroll-touch-edge',$1)">]
        abstract onceScrollTouchEdge : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('scroll-touch-edge',$1)">]
        abstract addListenerScrollTouchEdge : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('scroll-touch-edge',$1)">]
        abstract removeListenerScrollTouchEdge : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when scroll wheel event phase has ended.
        [<Emit"$0.on('scroll-touch-end',$1)">]
        abstract onScrollTouchEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('scroll-touch-end',$1)">]
        abstract onceScrollTouchEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('scroll-touch-end',$1)">]
        abstract addListenerScrollTouchEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('scroll-touch-end',$1)">]
        abstract removeListenerScrollTouchEnd : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when window session is going to end due to force shutdown or machine
        /// restart or session log off.
        [<Emit"$0.on('session-end',$1)">]
        abstract onSessionEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('session-end',$1)">]
        abstract onceSessionEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('session-end',$1)">]
        abstract addListenerSessionEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('session-end',$1)">]
        abstract removeListenerSessionEnd : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window opens a sheet.
        [<Emit"$0.on('sheet-begin',$1)">]
        abstract onSheetBegin : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('sheet-begin',$1)">]
        abstract onceSheetBegin : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('sheet-begin',$1)">]
        abstract addListenerSheetBegin : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('sheet-begin',$1)">]
        abstract removeListenerSheetBegin : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window has closed a sheet.
        [<Emit"$0.on('sheet-end',$1)">]
        abstract onSheetEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('sheet-end',$1)">]
        abstract onceSheetEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('sheet-end',$1)">]
        abstract addListenerSheetEnd : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('sheet-end',$1)">]
        abstract removeListenerSheetEnd : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the window is shown.
        [<Emit"$0.on('show',$1)">]
        abstract onShow : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('show',$1)">]
        abstract onceShow : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('show',$1)">]
        abstract addListenerShow : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('show',$1)">]
        abstract removeListenerShow : listener:(Event -> unit) -> BrowserWindow

        /// Emitted on 3-finger swipe. Possible directions are up, right, down, left.
        [<Emit"$0.on('swipe',$1)">]
        abstract onSwipe : listener:(Event -> string -> unit) -> BrowserWindow

        [<Emit"$0.once('swipe',$1)">]
        abstract onceSwipe : listener:(Event -> string -> unit) -> BrowserWindow

        [<Emit"$0.addListener('swipe',$1)">]
        abstract addListenerSwipe : listener:(Event -> string -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('swipe',$1)">]
        abstract removeListenerSwipe : listener:(Event -> string -> unit) -> BrowserWindow

        /// Emitted when the window exits from a maximized state.
        [<Emit"$0.on('unmaximize',$1)">]
        abstract onUnmaximize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('unmaximize',$1)">]
        abstract onceUnmaximize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('unmaximize',$1)">]
        abstract addListenerUnmaximize : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('unmaximize',$1)">]
        abstract removeListenerUnmaximize : listener:(Event -> unit) -> BrowserWindow

        /// Emitted when the web page becomes unresponsive.
        [<Emit"$0.on('unresponsive',$1)">]
        abstract onUnresponsive : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.once('unresponsive',$1)">]
        abstract onceUnresponsive : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.addListener('unresponsive',$1)">]
        abstract addListenerUnresponsive : listener:(Event -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('unresponsive',$1)">]
        abstract removeListenerUnresponsive : listener:(Event -> unit) -> BrowserWindow
        ...
        abstract onWillMove : listener:(Event -> Rectangle -> unit) -> BrowserWindow

        [<Emit"$0.once('will-move',$1)">]
        abstract onceWillMove : listener:(Event -> Rectangle -> unit) -> BrowserWindow

        [<Emit"$0.addListener('will-move',$1)">]
        abstract addListenerWillMove : listener:(Event -> Rectangle -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('will-move',$1)">]
        abstract removeListenerWillMove : listener:(Event -> Rectangle -> unit) -> BrowserWindow
        ...
        abstract onWillResize : listener:(Event -> Rectangle -> unit) -> BrowserWindow

        [<Emit"$0.once('will-resize',$1)">]
        abstract onceWillResize : listener:(Event -> Rectangle -> unit) -> BrowserWindow

        [<Emit"$0.addListener('will-resize',$1)">]
        abstract addListenerWillResize : listener:(Event -> Rectangle -> unit) -> BrowserWindow

        [<Emit"$0.removeListener('will-resize',$1)">]
        abstract removeListenerWillResize : listener:(Event -> Rectangle -> unit) -> BrowserWindow
    ...
    type BrowserWindowStatic =
        ...
        [<EmitConstructor>]
        abstract Create : options:BrowserWindowOptions -> BrowserWindow
    ...
    type ClientRequest =
        ...
        [<Emit"$0.on('abort',$1)">]
        abstract onAbort : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.once('abort',$1)">]
        abstract onceAbort : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.addListener('abort',$1)">]
        abstract addListenerAbort : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.removeListener('abort',$1)">]
        abstract removeListenerAbort : listener:(Event -> unit) -> ClientRequest

        /// Emitted as the last event in the HTTP request-response transaction. The close
        /// event indicates that no more events will be emitted on either the request or
        /// response objects.
        [<Emit"$0.on('close',$1)">]
        abstract onClose : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.once('close',$1)">]
        abstract onceClose : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.addListener('close',$1)">]
        abstract addListenerClose : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.removeListener('close',$1)">]
        abstract removeListenerClose : listener:(Event -> unit) -> ClientRequest
        ...
        [<Emit"$0.on('error',$1)">]
        abstract onError : listener:(Error -> unit) -> ClientRequest

        [<Emit"$0.once('error',$1)">]
        abstract onceError : listener:(Error -> unit) -> ClientRequest

        [<Emit"$0.addListener('error',$1)">]
        abstract addListenerError : listener:(Error -> unit) -> ClientRequest

        [<Emit"$0.removeListener('error',$1)">]
        abstract removeListenerError : listener:(Error -> unit) -> ClientRequest

        /// Emitted just after the last chunk of the request's data has been written into
        /// the request object.
        [<Emit"$0.on('finish',$1)">]
        abstract onFinish : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.once('finish',$1)">]
        abstract onceFinish : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.addListener('finish',$1)">]
        abstract addListenerFinish : listener:(Event -> unit) -> ClientRequest

        [<Emit"$0.removeListener('finish',$1)">]
        abstract removeListenerFinish : listener:(Event -> unit) -> ClientRequest
        ...
        /// the response object:
        [<Emit"$0.on('login',$1)">]
        abstract onLogin : listener:(AuthInfo -> (string -> string -> unit) -> unit) -> ClientRequest

        [<Emit"$0.once('login',$1)">]
        abstract onceLogin : listener:(AuthInfo -> (string -> string -> unit) -> unit) -> ClientRequest

        [<Emit"$0.addListener('login',$1)">]
        abstract addListenerLogin : listener:(AuthInfo -> (string -> string -> unit) -> unit) -> ClientRequest

        [<Emit"$0.removeListener('login',$1)">]
        abstract removeListenerLogin : listener:(AuthInfo -> (string -> string -> unit) -> unit) -> ClientRequest

        /// Emitted when there is redirection and the mode is manual. Calling
        /// request.followRedirect will continue with the redirection.
        [<Emit"$0.on('redirect',$1)">]
        abstract onRedirect : listener:(int -> string -> string -> obj option -> unit) -> ClientRequest

        [<Emit"$0.once('redirect',$1)">]
        abstract onceRedirect : listener:(int -> string -> string -> obj option -> unit) -> ClientRequest

        [<Emit"$0.addListener('redirect',$1)">]
        abstract addListenerRedirect : listener:(int -> string -> string -> obj option -> unit) -> ClientRequest

        [<Emit"$0.removeListener('redirect',$1)">]
        abstract removeListenerRedirect : listener:(int -> string -> string -> obj option -> unit) -> ClientRequest

        [<Emit"$0.on('response',$1)">]
        abstract onResponse : listener:(IncomingMessage -> unit) -> ClientRequest

        [<Emit"$0.once('response',$1)">]
        abstract onceResponse : listener:(IncomingMessage -> unit) -> ClientRequest

        [<Emit"$0.addListener('response',$1)">]
        abstract addListenerResponse : listener:(IncomingMessage -> unit) -> ClientRequest

        [<Emit"$0.removeListener('response',$1)">]
        abstract removeListenerResponse : listener:(IncomingMessage -> unit) -> ClientRequest
    ...
    type ClientRequestStatic =
        [<EmitConstructor>]
        abstract Create : options:U2<string, ClientRequestOptions> -> ClientRequest
    ...
    type Cookies =
        ...
        /// expired.
        [<Emit"$0.on('changed',$1)">]
        abstract onChanged : listener:(Event -> Cookie -> CookieChangedCause -> bool -> unit) -> Cookies

        [<Emit"$0.once('changed',$1)">]
        abstract onceChanged : listener:(Event -> Cookie -> CookieChangedCause -> bool -> unit) -> Cookies

        [<Emit"$0.addListener('changed',$1)">]
        abstract addListenerChanged : listener:(Event -> Cookie -> CookieChangedCause -> bool -> unit) -> Cookies

        [<Emit"$0.removeListener('changed',$1)">]
        abstract removeListenerChanged : listener:(Event -> Cookie -> CookieChangedCause -> bool -> unit) -> Cookies
    ...
    type Debugger =
        ...
        [<Emit"$0.on('detach',$1)">]
        abstract onDetach : listener:(Event -> string -> unit) -> Debugger

        [<Emit"$0.once('detach',$1)">]
        abstract onceDetach : listener:(Event -> string -> unit) -> Debugger

        [<Emit"$0.addListener('detach',$1)">]
        abstract addListenerDetach : listener:(Event -> string -> unit) -> Debugger

        [<Emit"$0.removeListener('detach',$1)">]
        abstract removeListenerDetach : listener:(Event -> string -> unit) -> Debugger

        /// Emitted whenever debugging target issues instrumentation event.
        [<Emit"$0.on('message',$1)">]
        abstract onMessage : listener:(Event -> string -> obj option -> unit) -> Debugger

        [<Emit"$0.once('message',$1)">]
        abstract onceMessage : listener:(Event -> string -> obj option -> unit) -> Debugger

        [<Emit"$0.addListener('message',$1)">]
        abstract addListenerMessage : listener:(Event -> string -> obj option -> unit) -> Debugger

        [<Emit"$0.removeListener('message',$1)">]
        abstract removeListenerMessage : listener:(Event -> string -> obj option -> unit) -> Debugger
    ...
    type DesktopCapturer =
        ...
        abstract getSources : options:GetDesktopCapturerSourcesOptions * callback:(Error -> DesktopCapturerSource [] -> unit)
         -> unit
    ...
    type Dialog =
        ...
        abstract showCertificateTrustDialog : browserWindow:BrowserWindow * options:CertificateTrustDialogOptions * callback:(Event -> unit)
         -> unit
        ...
        /// callback(response).
        abstract showMessageBox : browserWindow:BrowserWindow * options:MessageBoxOptions * callback:(int -> bool -> unit)
         -> unit
        ...
        abstract showOpenDialog : browserWindow:BrowserWindow * options:OpenDialogOptions * callback:(string [] -> string [] -> unit)
         -> unit
        ...
        /// the API call will be asynchronous and the result will be passed via
        /// callback(filename).
        abstract showSaveDialog : browserWindow:BrowserWindow * options:SaveDialogOptions * callback:(string option -> string option -> unit)
         -> unit
    ...
    type DownloadItem =
        ...
        [<Emit"$0.on('done',$1)">]
        abstract onDone : listener:(Event -> DownloadItemDoneState -> unit) -> DownloadItem

        [<Emit"$0.once('done',$1)">]
        abstract onceDone : listener:(Event -> DownloadItemDoneState -> unit) -> DownloadItem

        [<Emit"$0.addListener('done',$1)">]
        abstract addListenerDone : listener:(Event -> DownloadItemDoneState -> unit) -> DownloadItem

        [<Emit"$0.removeListener('done',$1)">]
        abstract removeListenerDone : listener:(Event -> DownloadItemDoneState -> unit) -> DownloadItem

        /// Emitted when the download has been updated and is not done. The state can be one
        /// of following:
        [<Emit"$0.on('updated',$1)">]
        abstract onUpdated : listener:(Event -> DownloadItemUpdatedState -> unit) -> DownloadItem

        [<Emit"$0.once('updated',$1)">]
        abstract onceUpdated : listener:(Event -> DownloadItemUpdatedState -> unit) -> DownloadItem

        [<Emit"$0.addListener('updated',$1)">]
        abstract addListenerUpdated : listener:(Event -> DownloadItemUpdatedState -> unit) -> DownloadItem

        [<Emit"$0.removeListener('updated',$1)">]
        abstract removeListenerUpdated : listener:(Event -> DownloadItemUpdatedState -> unit) -> DownloadItem
    ...
    type InAppPurchase =
        ...
        [<Emit"$0.on('transactions-updated',$1)">]
        abstract onTransactionsUpdated : listener:(Event -> Transaction [] -> unit) -> InAppPurchase

        [<Emit"$0.once('transactions-updated',$1)">]
        abstract onceTransactionsUpdated : listener:(Event -> Transaction [] -> unit) -> InAppPurchase

        [<Emit"$0.addListener('transactions-updated',$1)">]
        abstract addListenerTransactionsUpdated : listener:(Event -> Transaction [] -> unit) -> InAppPurchase

        [<Emit"$0.removeListener('transactions-updated',$1)">]
        abstract removeListenerTransactionsUpdated : listener:(Event -> Transaction [] -> unit) -> InAppPurchase
    ...
    type IncomingMessage =
        ...
        [<Emit"$0.on('aborted',$1)">]
        abstract onAborted : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.once('aborted',$1)">]
        abstract onceAborted : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.addListener('aborted',$1)">]
        abstract addListenerAborted : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.removeListener('aborted',$1)">]
        abstract removeListenerAborted : listener:(Event -> unit) -> IncomingMessage

        /// The data event is the usual method of transferring response data into
        /// applicative code.
        [<Emit"$0.on('data',$1)">]
        abstract onData : listener:(Buffer -> unit) -> IncomingMessage

        [<Emit"$0.once('data',$1)">]
        abstract onceData : listener:(Buffer -> unit) -> IncomingMessage

        [<Emit"$0.addListener('data',$1)">]
        abstract addListenerData : listener:(Buffer -> unit) -> IncomingMessage

        [<Emit"$0.removeListener('data',$1)">]
        abstract removeListenerData : listener:(Buffer -> unit) -> IncomingMessage

        /// Indicates that response body has ended.
        [<Emit"$0.on('end',$1)">]
        abstract onEnd : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.once('end',$1)">]
        abstract onceEnd : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.addListener('end',$1)">]
        abstract addListenerEnd : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.removeListener('end',$1)">]
        abstract removeListenerEnd : listener:(Event -> unit) -> IncomingMessage
        ...
        [<Emit"$0.on('error',$1)">]
        abstract onError : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.once('error',$1)">]
        abstract onceError : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.addListener('error',$1)">]
        abstract addListenerError : listener:(Event -> unit) -> IncomingMessage

        [<Emit"$0.removeListener('error',$1)">]
        abstract removeListenerError : listener:(Event -> unit) -> IncomingMessage
    ...
    type Menu =
        ...
        abstract onMenuWillClose : listener:(Event -> unit) -> Menu

        [<Emit"$0.once('menu-will-close',$1)">]
        abstract onceMenuWillClose : listener:(Event -> unit) -> Menu

        [<Emit"$0.addListener('menu-will-close',$1)">]
        abstract addListenerMenuWillClose : listener:(Event -> unit) -> Menu

        [<Emit"$0.removeListener('menu-will-close',$1)">]
        abstract removeListenerMenuWillClose : listener:(Event -> unit) -> Menu

        /// Emitted when menu.popup() is called.
        [<Emit"$0.on('menu-will-show',$1)">]
        abstract onMenuWillShow : listener:(Event -> unit) -> Menu

        [<Emit"$0.once('menu-will-show',$1)">]
        abstract onceMenuWillShow : listener:(Event -> unit) -> Menu

        [<Emit"$0.addListener('menu-will-show',$1)">]
        abstract addListenerMenuWillShow : listener:(Event -> unit) -> Menu

        [<Emit"$0.removeListener('menu-will-show',$1)">]
        abstract removeListenerMenuWillShow : listener:(Event -> unit) -> Menu
    ...
    type MenuItemStatic =
        [<EmitConstructor>]
        abstract Create : options:MenuItemOptions -> MenuItem
    ...
    type Notification =
        ...
        [<Emit"$0.on('action',$1)">]
        abstract onAction : listener:(Event -> int -> unit) -> Notification

        [<Emit"$0.once('action',$1)">]
        abstract onceAction : listener:(Event -> int -> unit) -> Notification

        [<Emit"$0.addListener('action',$1)">]
        abstract addListenerAction : listener:(Event -> int -> unit) -> Notification

        [<Emit"$0.removeListener('action',$1)">]
        abstract removeListenerAction : listener:(Event -> int -> unit) -> Notification

        /// Emitted when the notification is clicked by the user.
        [<Emit"$0.on('click',$1)">]
        abstract onClick : listener:(Event -> unit) -> Notification

        [<Emit"$0.once('click',$1)">]
        abstract onceClick : listener:(Event -> unit) -> Notification

        [<Emit"$0.addListener('click',$1)">]
        abstract addListenerClick : listener:(Event -> unit) -> Notification

        [<Emit"$0.removeListener('click',$1)">]
        abstract removeListenerClick : listener:(Event -> unit) -> Notification

        /// Emitted when the notification is closed by manual intervention from the user.
        /// This event is not guaranteed to be emitted in all cases where the notification
        /// is closed.
        [<Emit"$0.on('close',$1)">]
        abstract onClose : listener:(Event -> unit) -> Notification

        [<Emit"$0.once('close',$1)">]
        abstract onceClose : listener:(Event -> unit) -> Notification

        [<Emit"$0.addListener('close',$1)">]
        abstract addListenerClose : listener:(Event -> unit) -> Notification

        [<Emit"$0.removeListener('close',$1)">]
        abstract removeListenerClose : listener:(Event -> unit) -> Notification

        /// Emitted when the user clicks the "Reply" button on a notification with hasReply:
        /// true.
        [<Emit"$0.on('reply',$1)">]
        abstract onReply : listener:(Event -> string -> unit) -> Notification

        [<Emit"$0.once('reply',$1)">]
        abstract onceReply : listener:(Event -> string -> unit) -> Notification

        [<Emit"$0.addListener('reply',$1)">]
        abstract addListenerReply : listener:(Event -> string -> unit) -> Notification

        [<Emit"$0.removeListener('reply',$1)">]
        abstract removeListenerReply : listener:(Event -> string -> unit) -> Notification

        /// Emitted when the notification is shown to the user, note this could be fired
        /// multiple times as a notification can be shown multiple times through the show()
        /// method.
        [<Emit"$0.on('show',$1)">]
        abstract onShow : listener:(Event -> unit) -> Notification

        [<Emit"$0.once('show',$1)">]
        abstract onceShow : listener:(Event -> unit) -> Notification

        [<Emit"$0.addListener('show',$1)">]
        abstract addListenerShow : listener:(Event -> unit) -> Notification

        [<Emit"$0.removeListener('show',$1)">]
        abstract removeListenerShow : listener:(Event -> unit) -> Notification
    ...
    type NotificationStatic =
        ...
        [<EmitConstructor>]
        abstract Create : options:NotificationOptions -> Notification
    ...
    type PowerMonitor =
        ...
        [<Emit"$0.on('lock-screen',$1)">]
        abstract onLockScreen : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.once('lock-screen',$1)">]
        abstract onceLockScreen : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.addListener('lock-screen',$1)">]
        abstract addListenerLockScreen : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.removeListener('lock-screen',$1)">]
        abstract removeListenerLockScreen : listener:(Event -> unit) -> PowerMonitor

        /// Emitted when the system changes to AC power.
        [<Emit"$0.on('on-ac',$1)">]
        abstract onOnAc : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.once('on-ac',$1)">]
        abstract onceOnAc : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.addListener('on-ac',$1)">]
        abstract addListenerOnAc : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.removeListener('on-ac',$1)">]
        abstract removeListenerOnAc : listener:(Event -> unit) -> PowerMonitor

        /// Emitted when system changes to battery power.
        [<Emit"$0.on('on-battery',$1)">]
        abstract onOnBattery : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.once('on-battery',$1)">]
        abstract onceOnBattery : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.addListener('on-battery',$1)">]
        abstract addListenerOnBattery : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.removeListener('on-battery',$1)">]
        abstract removeListenerOnBattery : listener:(Event -> unit) -> PowerMonitor

        /// Emitted when system is resuming.
        [<Emit"$0.on('resume',$1)">]
        abstract onResume : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.once('resume',$1)">]
        abstract onceResume : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.addListener('resume',$1)">]
        abstract addListenerResume : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.removeListener('resume',$1)">]
        abstract removeListenerResume : listener:(Event -> unit) -> PowerMonitor

        /// Emitted when the system is about to reboot or shut down. If the event handler
        /// invokes e.preventDefault(), Electron will attempt to delay system shutdown in
        /// order for the app to exit cleanly. If e.preventDefault() is called, the app
        /// should exit as soon as possible by calling something like app.quit().
        [<Emit"$0.on('shutdown',$1)">]
        abstract onShutdown : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.once('shutdown',$1)">]
        abstract onceShutdown : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.addListener('shutdown',$1)">]
        abstract addListenerShutdown : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.removeListener('shutdown',$1)">]
        abstract removeListenerShutdown : listener:(Event -> unit) -> PowerMonitor

        /// Emitted when the system is suspending.
        [<Emit"$0.on('suspend',$1)">]
        abstract onSuspend : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.once('suspend',$1)">]
        abstract onceSuspend : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.addListener('suspend',$1)">]
        abstract addListenerSuspend : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.removeListener('suspend',$1)">]
        abstract removeListenerSuspend : listener:(Event -> unit) -> PowerMonitor

        /// Emitted as soon as the systems screen is unlocked.
        [<Emit"$0.on('unlock-screen',$1)">]
        abstract onUnlockScreen : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.once('unlock-screen',$1)">]
        abstract onceUnlockScreen : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.addListener('unlock-screen',$1)">]
        abstract addListenerUnlockScreen : listener:(Event -> unit) -> PowerMonitor

        [<Emit"$0.removeListener('unlock-screen',$1)">]
        abstract removeListenerUnlockScreen : listener:(Event -> unit) -> PowerMonitor
    ...
    type Protocol =
        ...
        abstract interceptBufferProtocol : scheme:string * handler:(InterceptBufferProtocolRequest -> (Buffer -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit

        /// Intercepts scheme protocol and uses handler as the protocol's new handler which
        /// sends a file as a response.
        abstract interceptFileProtocol : scheme:string * handler:(InterceptFileProtocolRequest -> (string -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit

        /// Intercepts scheme protocol and uses handler as the protocol's new handler which
        /// sends a new HTTP request as a response.
        abstract interceptHttpProtocol : scheme:string * handler:(InterceptHttpProtocolRequest -> (RedirectRequest -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit

        /// Same as protocol.registerStreamProtocol, except that it replaces an existing
        /// protocol handler.
        abstract interceptStreamProtocol : scheme:string * handler:(InterceptStreamProtocolRequest -> (U2<Node.Stream.Readable<'a>, StreamProtocolResponse<'a>> -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit

        /// Intercepts scheme protocol and uses handler as the protocol's new handler which
        /// sends a String as a response.
        abstract interceptStringProtocol : scheme:string * handler:(InterceptStringProtocolRequest -> (string -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        abstract registerBufferProtocol : scheme:string * handler:(RegisterBufferProtocolRequest -> (U2<Buffer, MimeTypedBuffer> -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        /// scheme.
        abstract registerFileProtocol : scheme:string * handler:(RegisterFileProtocolRequest -> (string -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        abstract registerHttpProtocol : scheme:string * handler:(RegisterHttpProtocolRequest -> (RedirectRequest -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        abstract registerStreamProtocol : scheme:string * handler:(RegisterStreamProtocolRequest -> (U2<Node.Stream.Readable<'a>, StreamProtocolResponse<'a>> -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        /// properties.
        abstract registerStringProtocol : scheme:string * handler:(RegisterStringProtocolRequest -> (string -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
    ...
    type Screen =
        ...
        [<Emit"$0.on('display-added',$1)">]
        abstract onDisplayAdded : listener:(Event -> Display -> unit) -> Screen

        [<Emit"$0.once('display-added',$1)">]
        abstract onceDisplayAdded : listener:(Event -> Display -> unit) -> Screen

        [<Emit"$0.addListener('display-added',$1)">]
        abstract addListenerDisplayAdded : listener:(Event -> Display -> unit) -> Screen

        [<Emit"$0.removeListener('display-added',$1)">]
        abstract removeListenerDisplayAdded : listener:(Event -> Display -> unit) -> Screen
        ...
        [<Emit"$0.on('display-metrics-changed',$1)">]
        abstract onDisplayMetricsChanged : listener:(Event -> Display -> string [] -> unit) -> Screen

        [<Emit"$0.once('display-metrics-changed',$1)">]
        abstract onceDisplayMetricsChanged : listener:(Event -> Display -> string [] -> unit) -> Screen

        [<Emit"$0.addListener('display-metrics-changed',$1)">]
        abstract addListenerDisplayMetricsChanged : listener:(Event -> Display -> string [] -> unit) -> Screen

        [<Emit"$0.removeListener('display-metrics-changed',$1)">]
        abstract removeListenerDisplayMetricsChanged : listener:(Event -> Display -> string [] -> unit) -> Screen

        /// Emitted when oldDisplay has been removed.
        [<Emit"$0.on('display-removed',$1)">]
        abstract onDisplayRemoved : listener:(Event -> Display -> unit) -> Screen

        [<Emit"$0.once('display-removed',$1)">]
        abstract onceDisplayRemoved : listener:(Event -> Display -> unit) -> Screen

        [<Emit"$0.addListener('display-removed',$1)">]
        abstract addListenerDisplayRemoved : listener:(Event -> Display -> unit) -> Screen

        [<Emit"$0.removeListener('display-removed',$1)">]
        abstract removeListenerDisplayRemoved : listener:(Event -> Display -> unit) -> Screen
    ...
    type Session =
        ...
        abstract onWillDownload : listener:(Event -> DownloadItem -> WebContents -> unit) -> Session

        [<Emit"$0.once('will-download',$1)">]
        abstract onceWillDownload : listener:(Event -> DownloadItem -> WebContents -> unit) -> Session

        [<Emit"$0.addListener('will-download',$1)">]
        abstract addListenerWillDownload : listener:(Event -> DownloadItem -> WebContents -> unit) -> Session

        [<Emit"$0.removeListener('will-download',$1)">]
        abstract removeListenerWillDownload : listener:(Event -> DownloadItem -> WebContents -> unit) -> Session
        ...
        abstract clearAuthCache : options:U2<RemovePassword, RemoveClientCertificate> * ?callback:(Event -> unit)
         -> unit
        ...
        abstract setPermissionCheckHandler : handler:(WebContents -> string -> string -> PermissionCheckHandlerDetails -> bool) option
         -> unit
        ...
        abstract setPermissionRequestHandler : handler:(WebContents -> string -> (bool -> unit) -> PermissionRequestHandlerDetails -> unit) option
         -> unit
    ...
    type Shell =
        ...
        abstract writeShortcutLink : shortcutPath:string * operation:WriteShortcutLinkOperation * options:ShortcutDetails
         -> bool
    ...
    type SystemPreferences =
        ...
        [<Emit"$0.on('accent-color-changed',$1)">]
        abstract onAccentColorChanged : listener:(Event -> string -> unit) -> SystemPreferences

        [<Emit"$0.once('accent-color-changed',$1)">]
        abstract onceAccentColorChanged : listener:(Event -> string -> unit) -> SystemPreferences

        [<Emit"$0.addListener('accent-color-changed',$1)">]
        abstract addListenerAccentColorChanged : listener:(Event -> string -> unit) -> SystemPreferences

        [<Emit"$0.removeListener('accent-color-changed',$1)">]
        abstract removeListenerAccentColorChanged : listener:(Event -> string -> unit) -> SystemPreferences

        /// NOTE: This event is only emitted after you have called
        /// startAppLevelAppearanceTrackingOS
        [<Emit"$0.on('appearance-changed',$1)">]
        abstract onAppearanceChanged : listener:(SetAppearance -> unit) -> SystemPreferences

        [<Emit"$0.once('appearance-changed',$1)">]
        abstract onceAppearanceChanged : listener:(SetAppearance -> unit) -> SystemPreferences

        [<Emit"$0.addListener('appearance-changed',$1)">]
        abstract addListenerAppearanceChanged : listener:(SetAppearance -> unit) -> SystemPreferences

        [<Emit"$0.removeListener('appearance-changed',$1)">]
        abstract removeListenerAppearanceChanged : listener:(SetAppearance -> unit) -> SystemPreferences

        [<Emit"$0.on('color-changed',$1)">]
        abstract onColorChanged : listener:(Event -> unit) -> SystemPreferences

        [<Emit"$0.once('color-changed',$1)">]
        abstract onceColorChanged : listener:(Event -> unit) -> SystemPreferences

        [<Emit"$0.addListener('color-changed',$1)">]
        abstract addListenerColorChanged : listener:(Event -> unit) -> SystemPreferences

        [<Emit"$0.removeListener('color-changed',$1)">]
        abstract removeListenerColorChanged : listener:(Event -> unit) -> SystemPreferences

        [<Emit"$0.on('high-contrast-color-scheme-changed',$1)">]
        abstract onHighContrastColorSchemeChanged : listener:(Event -> bool -> unit) -> SystemPreferences

        [<Emit"$0.once('high-contrast-color-scheme-changed',$1)">]
        abstract onceHighContrastColorSchemeChanged : listener:(Event -> bool -> unit) -> SystemPreferences

        [<Emit"$0.addListener('high-contrast-color-scheme-changed',$1)">]
        abstract addListenerHighContrastColorSchemeChanged : listener:(Event -> bool -> unit) -> SystemPreferences

        [<Emit"$0.removeListener('high-contrast-color-scheme-changed',$1)">]
        abstract removeListenerHighContrastColorSchemeChanged : listener:(Event -> bool -> unit) -> SystemPreferences

        [<Emit"$0.on('inverted-color-scheme-changed',$1)">]
        abstract onInvertedColorSchemeChanged : listener:(Event -> bool -> unit) -> SystemPreferences

        [<Emit"$0.once('inverted-color-scheme-changed',$1)">]
        abstract onceInvertedColorSchemeChanged : listener:(Event -> bool -> unit) -> SystemPreferences

        [<Emit"$0.addListener('inverted-color-scheme-changed',$1)">]
        abstract addListenerInvertedColorSchemeChanged : listener:(Event -> bool -> unit) -> SystemPreferences

        [<Emit"$0.removeListener('inverted-color-scheme-changed',$1)">]
        abstract removeListenerInvertedColorSchemeChanged : listener:(Event -> bool -> unit) -> SystemPreferences
    ...
    type TouchBarButtonStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarButtonOptions -> TouchBarButton
    ...
    type TouchBarColorPickerStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarColorPickerOptions -> TouchBarColorPicker
    ...
    type TouchBarGroupStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarGroupOptions -> TouchBarGroup
    ...
    type TouchBarLabelStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarLabelOptions -> TouchBarLabel
    ...
    type TouchBarPopoverStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarPopoverOptions -> TouchBarPopover
    ...
    type TouchBarScrubberStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarScrubberOptions -> TouchBarScrubber
    ...
    type TouchBarSegmentedControlStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarSegmentedControlOptions -> TouchBarSegmentedControl
    ...
    type TouchBarSliderStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarSliderOptions -> TouchBarSlider
    ...
    type TouchBarSpacerStatic =
        [<EmitConstructor>]
        abstract Create : options:TouchBarSpacerOptions -> TouchBarSpacer
    ...
    type TouchBarStatic =
        ...
        [<EmitConstructor>]
        abstract Create : options:TouchBarOptions -> TouchBar
    ...
    type Tray =
        ...
        abstract onBalloonClick : listener:(Event -> unit) -> Tray

        [<Emit"$0.once('balloon-click',$1)">]
        abstract onceBalloonClick : listener:(Event -> unit) -> Tray

        [<Emit"$0.addListener('balloon-click',$1)">]
        abstract addListenerBalloonClick : listener:(Event -> unit) -> Tray

        [<Emit"$0.removeListener('balloon-click',$1)">]
        abstract removeListenerBalloonClick : listener:(Event -> unit) -> Tray

        /// Emitted when the tray balloon is closed because of timeout or user manually
        /// closes it.
        [<Emit"$0.on('balloon-closed',$1)">]
        abstract onBalloonClosed : listener:(Event -> unit) -> Tray

        [<Emit"$0.once('balloon-closed',$1)">]
        abstract onceBalloonClosed : listener:(Event -> unit) -> Tray

        [<Emit"$0.addListener('balloon-closed',$1)">]
        abstract addListenerBalloonClosed : listener:(Event -> unit) -> Tray

        [<Emit"$0.removeListener('balloon-closed',$1)">]
        abstract removeListenerBalloonClosed : listener:(Event -> unit) -> Tray

        /// Emitted when the tray balloon shows.
        [<Emit"$0.on('balloon-show',$1)">]
        abstract onBalloonShow : listener:(Event -> unit) -> Tray

        [<Emit"$0.once('balloon-show',$1)">]
        abstract onceBalloonShow : listener:(Event -> unit) -> Tray

        [<Emit"$0.addListener('balloon-show',$1)">]
        abstract addListenerBalloonShow : listener:(Event -> unit) -> Tray

        [<Emit"$0.removeListener('balloon-show',$1)">]
        abstract removeListenerBalloonShow : listener:(Event -> unit) -> Tray

        /// Emitted when the tray icon is clicked.
        [<Emit"$0.on('click',$1)">]
        abstract onClick : listener:(TrayInputEvent -> Rectangle -> Point -> unit) -> Tray

        [<Emit"$0.once('click',$1)">]
        abstract onceClick : listener:(TrayInputEvent -> Rectangle -> Point -> unit) -> Tray

        [<Emit"$0.addListener('click',$1)">]
        abstract addListenerClick : listener:(TrayInputEvent -> Rectangle -> Point -> unit) -> Tray

        [<Emit"$0.removeListener('click',$1)">]
        abstract removeListenerClick : listener:(TrayInputEvent -> Rectangle -> Point -> unit) -> Tray

        /// Emitted when the tray icon is double clicked.
        [<Emit"$0.on('double-click',$1)">]
        abstract onDoubleClick : listener:(TrayInputEvent -> Rectangle -> unit) -> Tray

        [<Emit"$0.once('double-click',$1)">]
        abstract onceDoubleClick : listener:(TrayInputEvent -> Rectangle -> unit) -> Tray

        [<Emit"$0.addListener('double-click',$1)">]
        abstract addListenerDoubleClick : listener:(TrayInputEvent -> Rectangle -> unit) -> Tray

        [<Emit"$0.removeListener('double-click',$1)">]
        abstract removeListenerDoubleClick : listener:(TrayInputEvent -> Rectangle -> unit) -> Tray

        /// Emitted when a drag operation ends on the tray or ends at another location.
        [<Emit"$0.on('drag-end',$1)">]
        abstract onDragEnd : listener:(Event -> unit) -> Tray

        [<Emit"$0.once('drag-end',$1)">]
        abstract onceDragEnd : listener:(Event -> unit) -> Tray

        [<Emit"$0.addListener('drag-end',$1)">]
        abstract addListenerDragEnd : listener:(Event -> unit) -> Tray

        [<Emit"$0.removeListener('drag-end',$1)">]
        abstract removeListenerDragEnd : listener:(Event -> unit) -> Tray

        /// Emitted when a drag operation enters the tray icon.
        [<Emit"$0.on('drag-enter',$1)">]
        abstract onDragEnter : listener:(Event -> unit) -> Tray

        [<Emit"$0.once('drag-enter',$1)">]
        abstract onceDragEnter : listener:(Event -> unit) -> Tray

        [<Emit"$0.addListener('drag-enter',$1)">]
        abstract addListenerDragEnter : listener:(Event -> unit) -> Tray

        [<Emit"$0.removeListener('drag-enter',$1)">]
        abstract removeListenerDragEnter : listener:(Event -> unit) -> Tray

        /// Emitted when a drag operation exits the tray icon.
        [<Emit"$0.on('drag-leave',$1)">]
        abstract onDragLeave : listener:(Event -> unit) -> Tray

        [<Emit"$0.once('drag-leave',$1)">]
        abstract onceDragLeave : listener:(Event -> unit) -> Tray

        [<Emit"$0.addListener('drag-leave',$1)">]
        abstract addListenerDragLeave : listener:(Event -> unit) -> Tray

        [<Emit"$0.removeListener('drag-leave',$1)">]
        abstract removeListenerDragLeave : listener:(Event -> unit) -> Tray

        /// Emitted when any dragged items are dropped on the tray icon.
        [<Emit"$0.on('drop',$1)">]
        abstract onDrop : listener:(Event -> unit) -> Tray

        [<Emit"$0.once('drop',$1)">]
        abstract onceDrop : listener:(Event -> unit) -> Tray

        [<Emit"$0.addListener('drop',$1)">]
        abstract addListenerDrop : listener:(Event -> unit) -> Tray

        [<Emit"$0.removeListener('drop',$1)">]
        abstract removeListenerDrop : listener:(Event -> unit) -> Tray

        /// Emitted when dragged files are dropped in the tray icon.
        [<Emit"$0.on('drop-files',$1)">]
        abstract onDropFiles : listener:(Event -> string [] -> unit) -> Tray

        [<Emit"$0.once('drop-files',$1)">]
        abstract onceDropFiles : listener:(Event -> string [] -> unit) -> Tray

        [<Emit"$0.addListener('drop-files',$1)">]
        abstract addListenerDropFiles : listener:(Event -> string [] -> unit) -> Tray

        [<Emit"$0.removeListener('drop-files',$1)">]
        abstract removeListenerDropFiles : listener:(Event -> string [] -> unit) -> Tray

        /// Emitted when dragged text is dropped in the tray icon.
        [<Emit"$0.on('drop-text',$1)">]
        abstract onDropText : listener:(Event -> string -> unit) -> Tray

        [<Emit"$0.once('drop-text',$1)">]
        abstract onceDropText : listener:(Event -> string -> unit) -> Tray

        [<Emit"$0.addListener('drop-text',$1)">]
        abstract addListenerDropText : listener:(Event -> string -> unit) -> Tray

        [<Emit"$0.removeListener('drop-text',$1)">]
        abstract removeListenerDropText : listener:(Event -> string -> unit) -> Tray

        /// Emitted when the mouse enters the tray icon.
        [<Emit"$0.on('mouse-enter',$1)">]
        abstract onMouseEnter : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.once('mouse-enter',$1)">]
        abstract onceMouseEnter : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.addListener('mouse-enter',$1)">]
        abstract addListenerMouseEnter : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.removeListener('mouse-enter',$1)">]
        abstract removeListenerMouseEnter : listener:(TrayInputEvent -> Point -> unit) -> Tray

        /// Emitted when the mouse exits the tray icon.
        [<Emit"$0.on('mouse-leave',$1)">]
        abstract onMouseLeave : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.once('mouse-leave',$1)">]
        abstract onceMouseLeave : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.addListener('mouse-leave',$1)">]
        abstract addListenerMouseLeave : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.removeListener('mouse-leave',$1)">]
        abstract removeListenerMouseLeave : listener:(TrayInputEvent -> Point -> unit) -> Tray

        /// Emitted when the mouse moves in the tray icon.
        [<Emit"$0.on('mouse-move',$1)">]
        abstract onMouseMove : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.once('mouse-move',$1)">]
        abstract onceMouseMove : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.addListener('mouse-move',$1)">]
        abstract addListenerMouseMove : listener:(TrayInputEvent -> Point -> unit) -> Tray

        [<Emit"$0.removeListener('mouse-move',$1)">]
        abstract removeListenerMouseMove : listener:(TrayInputEvent -> Point -> unit) -> Tray

        /// Emitted when the tray icon is right clicked.
        [<Emit"$0.on('right-click',$1)">]
        abstract onRightClick : listener:(TrayInputEvent -> Rectangle -> unit) -> Tray

        [<Emit"$0.once('right-click',$1)">]
        abstract onceRightClick : listener:(TrayInputEvent -> Rectangle -> unit) -> Tray

        [<Emit"$0.addListener('right-click',$1)">]
        abstract addListenerRightClick : listener:(TrayInputEvent -> Rectangle -> unit) -> Tray

        [<Emit"$0.removeListener('right-click',$1)">]
        abstract removeListenerRightClick : listener:(TrayInputEvent -> Rectangle -> unit) -> Tray
    ...
    type TrayStatic =
        [<EmitConstructor>]
        abstract Create : image:U2<NativeImage, string> -> Tray
    ...
    type WebContents =
        ...
        abstract onBeforeInputEvent : listener:(Event -> BeforeInputEventData -> unit) -> WebContents

        [<Emit"$0.once('before-input-event',$1)">]
        abstract onceBeforeInputEvent : listener:(Event -> BeforeInputEventData -> unit) -> WebContents

        [<Emit"$0.addListener('before-input-event',$1)">]
        abstract addListenerBeforeInputEvent : listener:(Event -> BeforeInputEventData -> unit) -> WebContents

        [<Emit"$0.removeListener('before-input-event',$1)">]
        abstract removeListenerBeforeInputEvent : listener:(Event -> BeforeInputEventData -> unit) -> WebContents

        /// Emitted when failed to verify the certificate for url. The usage is the same
        /// with the certificate-error event of app.
        [<Emit"$0.on('certificate-error',$1)">]
        abstract onCertificateError : listener:(Event -> string -> string -> Certificate -> (bool -> unit) -> unit)
         -> WebContents

        [<Emit"$0.once('certificate-error',$1)">]
        abstract onceCertificateError : listener:(Event -> string -> string -> Certificate -> (bool -> unit) -> unit)
         -> WebContents

        [<Emit"$0.addListener('certificate-error',$1)">]
        abstract addListenerCertificateError : listener:(Event -> string -> string -> Certificate -> (bool -> unit) -> unit)
         -> WebContents

        [<Emit"$0.removeListener('certificate-error',$1)">]
        abstract removeListenerCertificateError : listener:(Event -> string -> string -> Certificate -> (bool -> unit) -> unit)
         -> WebContents

        /// Emitted when the associated window logs a console message. Will not be emitted
        /// for windows with offscreen rendering enabled.
        [<Emit"$0.on('console-message',$1)">]
        abstract onConsoleMessage : listener:(Event -> int -> string -> int -> string -> unit) -> WebContents

        [<Emit"$0.once('console-message',$1)">]
        abstract onceConsoleMessage : listener:(Event -> int -> string -> int -> string -> unit) -> WebContents

        [<Emit"$0.addListener('console-message',$1)">]
        abstract addListenerConsoleMessage : listener:(Event -> int -> string -> int -> string -> unit) -> WebContents

        [<Emit"$0.removeListener('console-message',$1)">]
        abstract removeListenerConsoleMessage : listener:(Event -> int -> string -> int -> string -> unit)
         -> WebContents

        /// Emitted when there is a new context menu that needs to be handled.
        [<Emit"$0.on('context-menu',$1)">]
        abstract onContextMenu : listener:(Event -> ContextMenuParams -> unit) -> WebContents

        [<Emit"$0.once('context-menu',$1)">]
        abstract onceContextMenu : listener:(Event -> ContextMenuParams -> unit) -> WebContents

        [<Emit"$0.addListener('context-menu',$1)">]
        abstract addListenerContextMenu : listener:(Event -> ContextMenuParams -> unit) -> WebContents

        [<Emit"$0.removeListener('context-menu',$1)">]
        abstract removeListenerContextMenu : listener:(Event -> ContextMenuParams -> unit) -> WebContents

        /// Emitted when the renderer process crashes or is killed.
        [<Emit"$0.on('crashed',$1)">]
        abstract onCrashed : listener:(Event -> bool -> unit) -> WebContents

        [<Emit"$0.once('crashed',$1)">]
        abstract onceCrashed : listener:(Event -> bool -> unit) -> WebContents

        [<Emit"$0.addListener('crashed',$1)">]
        abstract addListenerCrashed : listener:(Event -> bool -> unit) -> WebContents

        [<Emit"$0.removeListener('crashed',$1)">]
        abstract removeListenerCrashed : listener:(Event -> bool -> unit) -> WebContents
        ...
        abstract onCursorChanged : listener:(Event -> string -> NativeImage -> float -> Size -> Point -> unit)
         -> WebContents

        [<Emit"$0.once('cursor-changed',$1)">]
        abstract onceCursorChanged : listener:(Event -> string -> NativeImage -> float -> Size -> Point -> unit)
         -> WebContents

        [<Emit"$0.addListener('cursor-changed',$1)">]
        abstract addListenerCursorChanged : listener:(Event -> string -> NativeImage -> float -> Size -> Point -> unit)
         -> WebContents

        [<Emit"$0.removeListener('cursor-changed',$1)">]
        abstract removeListenerCursorChanged : listener:(Event -> string -> NativeImage -> float -> Size -> Point -> unit)
         -> WebContents

        /// Emitted when desktopCapturer.getSources() is called in the renderer process.
        /// Calling event.preventDefault() will make it return empty sources.
        [<Emit"$0.on('desktop-capturer-get-sources',$1)">]
        abstract onDesktopCapturerGetSources : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('desktop-capturer-get-sources',$1)">]
        abstract onceDesktopCapturerGetSources : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('desktop-capturer-get-sources',$1)">]
        abstract addListenerDesktopCapturerGetSources : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('desktop-capturer-get-sources',$1)">]
        abstract removeListenerDesktopCapturerGetSources : listener:(Event -> unit) -> WebContents

        /// Emitted when webContents is destroyed.
        [<Emit"$0.on('destroyed',$1)">]
        abstract onDestroyed : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('destroyed',$1)">]
        abstract onceDestroyed : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('destroyed',$1)">]
        abstract addListenerDestroyed : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('destroyed',$1)">]
        abstract removeListenerDestroyed : listener:(Event -> unit) -> WebContents

        /// Emitted when DevTools is closed.
        [<Emit"$0.on('devtools-closed',$1)">]
        abstract onDevtoolsClosed : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('devtools-closed',$1)">]
        abstract onceDevtoolsClosed : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('devtools-closed',$1)">]
        abstract addListenerDevtoolsClosed : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('devtools-closed',$1)">]
        abstract removeListenerDevtoolsClosed : listener:(Event -> unit) -> WebContents

        /// Emitted when DevTools is focused / opened.
        [<Emit"$0.on('devtools-focused',$1)">]
        abstract onDevtoolsFocused : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('devtools-focused',$1)">]
        abstract onceDevtoolsFocused : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('devtools-focused',$1)">]
        abstract addListenerDevtoolsFocused : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('devtools-focused',$1)">]
        abstract removeListenerDevtoolsFocused : listener:(Event -> unit) -> WebContents

        /// Emitted when DevTools is opened.
        [<Emit"$0.on('devtools-opened',$1)">]
        abstract onDevtoolsOpened : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('devtools-opened',$1)">]
        abstract onceDevtoolsOpened : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('devtools-opened',$1)">]
        abstract addListenerDevtoolsOpened : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('devtools-opened',$1)">]
        abstract removeListenerDevtoolsOpened : listener:(Event -> unit) -> WebContents

        /// Emitted when the devtools window instructs the webContents to reload
        [<Emit"$0.on('devtools-reload-page',$1)">]
        abstract onDevtoolsReloadPage : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('devtools-reload-page',$1)">]
        abstract onceDevtoolsReloadPage : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('devtools-reload-page',$1)">]
        abstract addListenerDevtoolsReloadPage : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('devtools-reload-page',$1)">]
        abstract removeListenerDevtoolsReloadPage : listener:(Event -> unit) -> WebContents

        /// Emitted when a <webview> has been attached to this web contents.
        [<Emit"$0.on('did-attach-webview',$1)">]
        abstract onDidAttachWebview : listener:(Event -> WebContents -> unit) -> WebContents

        [<Emit"$0.once('did-attach-webview',$1)">]
        abstract onceDidAttachWebview : listener:(Event -> WebContents -> unit) -> WebContents

        [<Emit"$0.addListener('did-attach-webview',$1)">]
        abstract addListenerDidAttachWebview : listener:(Event -> WebContents -> unit) -> WebContents

        [<Emit"$0.removeListener('did-attach-webview',$1)">]
        abstract removeListenerDidAttachWebview : listener:(Event -> WebContents -> unit) -> WebContents

        /// Emitted when a page's theme color changes. This is usually due to encountering a
        /// meta tag:
        [<Emit"$0.on('did-change-theme-color',$1)">]
        abstract onDidChangeThemeColor : listener:(Event -> string option -> unit) -> WebContents

        [<Emit"$0.once('did-change-theme-color',$1)">]
        abstract onceDidChangeThemeColor : listener:(Event -> string option -> unit) -> WebContents

        [<Emit"$0.addListener('did-change-theme-color',$1)">]
        abstract addListenerDidChangeThemeColor : listener:(Event -> string option -> unit) -> WebContents

        [<Emit"$0.removeListener('did-change-theme-color',$1)">]
        abstract removeListenerDidChangeThemeColor : listener:(Event -> string option -> unit) -> WebContents
        ...
        abstract onDidFailLoad : listener:(Event -> int -> string -> string -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.once('did-fail-load',$1)">]
        abstract onceDidFailLoad : listener:(Event -> int -> string -> string -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.addListener('did-fail-load',$1)">]
        abstract addListenerDidFailLoad : listener:(Event -> int -> string -> string -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.removeListener('did-fail-load',$1)">]
        abstract removeListenerDidFailLoad : listener:(Event -> int -> string -> string -> bool -> int -> int -> unit)
         -> WebContents

        /// Emitted when the navigation is done, i.e. the spinner of the tab has stopped
        /// spinning, and the onload event was dispatched.
        [<Emit"$0.on('did-finish-load',$1)">]
        abstract onDidFinishLoad : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('did-finish-load',$1)">]
        abstract onceDidFinishLoad : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('did-finish-load',$1)">]
        abstract addListenerDidFinishLoad : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('did-finish-load',$1)">]
        abstract removeListenerDidFinishLoad : listener:(Event -> unit) -> WebContents

        /// Emitted when a frame has done navigation.
        [<Emit"$0.on('did-frame-finish-load',$1)">]
        abstract onDidFrameFinishLoad : listener:(Event -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.once('did-frame-finish-load',$1)">]
        abstract onceDidFrameFinishLoad : listener:(Event -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.addListener('did-frame-finish-load',$1)">]
        abstract addListenerDidFrameFinishLoad : listener:(Event -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.removeListener('did-frame-finish-load',$1)">]
        abstract removeListenerDidFrameFinishLoad : listener:(Event -> bool -> int -> int -> unit) -> WebContents
        ...
        abstract onDidFrameNavigate : listener:(Event -> string -> int -> string -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.once('did-frame-navigate',$1)">]
        abstract onceDidFrameNavigate : listener:(Event -> string -> int -> string -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.addListener('did-frame-navigate',$1)">]
        abstract addListenerDidFrameNavigate : listener:(Event -> string -> int -> string -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.removeListener('did-frame-navigate',$1)">]
        abstract removeListenerDidFrameNavigate : listener:(Event -> string -> int -> string -> bool -> int -> int -> unit)
         -> WebContents
        ...
        abstract onDidNavigate : listener:(Event -> string -> int -> string -> unit) -> WebContents

        [<Emit"$0.once('did-navigate',$1)">]
        abstract onceDidNavigate : listener:(Event -> string -> int -> string -> unit) -> WebContents

        [<Emit"$0.addListener('did-navigate',$1)">]
        abstract addListenerDidNavigate : listener:(Event -> string -> int -> string -> unit) -> WebContents

        [<Emit"$0.removeListener('did-navigate',$1)">]
        abstract removeListenerDidNavigate : listener:(Event -> string -> int -> string -> unit) -> WebContents
        ...
        abstract onDidNavigateInPage : listener:(Event -> string -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.once('did-navigate-in-page',$1)">]
        abstract onceDidNavigateInPage : listener:(Event -> string -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.addListener('did-navigate-in-page',$1)">]
        abstract addListenerDidNavigateInPage : listener:(Event -> string -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.removeListener('did-navigate-in-page',$1)">]
        abstract removeListenerDidNavigateInPage : listener:(Event -> string -> bool -> int -> int -> unit)
         -> WebContents
        ...
        abstract onDidRedirectNavigation : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.once('did-redirect-navigation',$1)">]
        abstract onceDidRedirectNavigation : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.addListener('did-redirect-navigation',$1)">]
        abstract addListenerDidRedirectNavigation : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.removeListener('did-redirect-navigation',$1)">]
        abstract removeListenerDidRedirectNavigation : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents

        /// Corresponds to the points in time when the spinner of the tab started spinning.
        [<Emit"$0.on('did-start-loading',$1)">]
        abstract onDidStartLoading : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('did-start-loading',$1)">]
        abstract onceDidStartLoading : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('did-start-loading',$1)">]
        abstract addListenerDidStartLoading : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('did-start-loading',$1)">]
        abstract removeListenerDidStartLoading : listener:(Event -> unit) -> WebContents

        /// Emitted when any frame (including main) starts navigating. isInplace will be
        /// true for in-page navigations.
        [<Emit"$0.on('did-start-navigation',$1)">]
        abstract onDidStartNavigation : listener:(Event -> string -> bool -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.once('did-start-navigation',$1)">]
        abstract onceDidStartNavigation : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.addListener('did-start-navigation',$1)">]
        abstract addListenerDidStartNavigation : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.removeListener('did-start-navigation',$1)">]
        abstract removeListenerDidStartNavigation : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents

        /// Corresponds to the points in time when the spinner of the tab stopped spinning.
        [<Emit"$0.on('did-stop-loading',$1)">]
        abstract onDidStopLoading : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('did-stop-loading',$1)">]
        abstract onceDidStopLoading : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('did-stop-loading',$1)">]
        abstract addListenerDidStopLoading : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('did-stop-loading',$1)">]
        abstract removeListenerDidStopLoading : listener:(Event -> unit) -> WebContents

        /// Emitted when the document in the given frame is loaded.
        [<Emit"$0.on('dom-ready',$1)">]
        abstract onDomReady : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('dom-ready',$1)">]
        abstract onceDomReady : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('dom-ready',$1)">]
        abstract addListenerDomReady : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('dom-ready',$1)">]
        abstract removeListenerDomReady : listener:(Event -> unit) -> WebContents

        /// Emitted when a result is available for [webContents.findInPage] request.
        [<Emit"$0.on('found-in-page',$1)">]
        abstract onFoundInPage : listener:(Event -> FoundInPageResult -> unit) -> WebContents

        [<Emit"$0.once('found-in-page',$1)">]
        abstract onceFoundInPage : listener:(Event -> FoundInPageResult -> unit) -> WebContents

        [<Emit"$0.addListener('found-in-page',$1)">]
        abstract addListenerFoundInPage : listener:(Event -> FoundInPageResult -> unit) -> WebContents

        [<Emit"$0.removeListener('found-in-page',$1)">]
        abstract removeListenerFoundInPage : listener:(Event -> FoundInPageResult -> unit) -> WebContents

        /// Emitted when the renderer process sends an asynchronous message via
        /// ipcRenderer.send().
        [<Emit"$0.on('ipc-message',$1)">]
        abstract onIpcMessage : listener:(Event -> string -> obj [] -> unit) -> WebContents

        [<Emit"$0.once('ipc-message',$1)">]
        abstract onceIpcMessage : listener:(Event -> string -> obj [] -> unit) -> WebContents

        [<Emit"$0.addListener('ipc-message',$1)">]
        abstract addListenerIpcMessage : listener:(Event -> string -> obj [] -> unit) -> WebContents

        [<Emit"$0.removeListener('ipc-message',$1)">]
        abstract removeListenerIpcMessage : listener:(Event -> string -> obj [] -> unit) -> WebContents

        /// Emitted when the renderer process sends a synchronous message via
        /// ipcRenderer.sendSync().
        [<Emit"$0.on('ipc-message-sync',$1)">]
        abstract onIpcMessageSync : listener:(Event -> string -> obj [] -> unit) -> WebContents

        [<Emit"$0.once('ipc-message-sync',$1)">]
        abstract onceIpcMessageSync : listener:(Event -> string -> obj [] -> unit) -> WebContents

        [<Emit"$0.addListener('ipc-message-sync',$1)">]
        abstract addListenerIpcMessageSync : listener:(Event -> string -> obj [] -> unit) -> WebContents

        [<Emit"$0.removeListener('ipc-message-sync',$1)">]
        abstract removeListenerIpcMessageSync : listener:(Event -> string -> obj [] -> unit) -> WebContents

        /// Emitted when webContents wants to do basic auth. The usage is the same with the
        /// login event of app.
        [<Emit"$0.on('login',$1)">]
        abstract onLogin : listener:(Event -> LoginRequest -> AuthInfo -> (string -> string -> unit) -> unit)
         -> WebContents

        [<Emit"$0.once('login',$1)">]
        abstract onceLogin : listener:(Event -> LoginRequest -> AuthInfo -> (string -> string -> unit) -> unit)
         -> WebContents

        [<Emit"$0.addListener('login',$1)">]
        abstract addListenerLogin : listener:(Event -> LoginRequest -> AuthInfo -> (string -> string -> unit) -> unit)
         -> WebContents

        [<Emit"$0.removeListener('login',$1)">]
        abstract removeListenerLogin : listener:(Event -> LoginRequest -> AuthInfo -> (string -> string -> unit) -> unit)
         -> WebContents

        /// Emitted when media is paused or done playing.
        [<Emit"$0.on('media-paused',$1)">]
        abstract onMediaPaused : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('media-paused',$1)">]
        abstract onceMediaPaused : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('media-paused',$1)">]
        abstract addListenerMediaPaused : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('media-paused',$1)">]
        abstract removeListenerMediaPaused : listener:(Event -> unit) -> WebContents

        /// Emitted when media starts playing.
        [<Emit"$0.on('media-started-playing',$1)">]
        abstract onMediaStartedPlaying : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('media-started-playing',$1)">]
        abstract onceMediaStartedPlaying : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('media-started-playing',$1)">]
        abstract addListenerMediaStartedPlaying : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('media-started-playing',$1)">]
        abstract removeListenerMediaStartedPlaying : listener:(Event -> unit) -> WebContents
        ...
        /// example:
        [<Emit"$0.on('new-window',$1)">]
        abstract onNewWindow : listener:(Event -> string -> string -> WindowDisposition -> BrowserWindowOptions -> string [] -> Referrer -> unit)
         -> WebContents

        [<Emit"$0.once('new-window',$1)">]
        abstract onceNewWindow : listener:(Event -> string -> string -> WindowDisposition -> BrowserWindowOptions -> string [] -> Referrer -> unit)
         -> WebContents

        [<Emit"$0.addListener('new-window',$1)">]
        abstract addListenerNewWindow : listener:(Event -> string -> string -> WindowDisposition -> BrowserWindowOptions -> string [] -> Referrer -> unit)
         -> WebContents

        [<Emit"$0.removeListener('new-window',$1)">]
        abstract removeListenerNewWindow : listener:(Event -> string -> string -> WindowDisposition -> BrowserWindowOptions -> string [] -> Referrer -> unit)
         -> WebContents

        /// Emitted when page receives favicon urls.
        [<Emit"$0.on('page-favicon-updated',$1)">]
        abstract onPageFaviconUpdated : listener:(Event -> string [] -> unit) -> WebContents

        [<Emit"$0.once('page-favicon-updated',$1)">]
        abstract oncePageFaviconUpdated : listener:(Event -> string [] -> unit) -> WebContents

        [<Emit"$0.addListener('page-favicon-updated',$1)">]
        abstract addListenerPageFaviconUpdated : listener:(Event -> string [] -> unit) -> WebContents

        [<Emit"$0.removeListener('page-favicon-updated',$1)">]
        abstract removeListenerPageFaviconUpdated : listener:(Event -> string [] -> unit) -> WebContents

        /// Fired when page title is set during navigation. explicitSet is false when title
        /// is synthesized from file url.
        [<Emit"$0.on('page-title-updated',$1)">]
        abstract onPageTitleUpdated : listener:(Event -> string -> bool -> unit) -> WebContents

        [<Emit"$0.once('page-title-updated',$1)">]
        abstract oncePageTitleUpdated : listener:(Event -> string -> bool -> unit) -> WebContents

        [<Emit"$0.addListener('page-title-updated',$1)">]
        abstract addListenerPageTitleUpdated : listener:(Event -> string -> bool -> unit) -> WebContents

        [<Emit"$0.removeListener('page-title-updated',$1)">]
        abstract removeListenerPageTitleUpdated : listener:(Event -> string -> bool -> unit) -> WebContents

        /// Emitted when a new frame is generated. Only the dirty area is passed in the
        /// buffer.
        [<Emit"$0.on('paint',$1)">]
        abstract onPaint : listener:(Event -> Rectangle -> NativeImage -> unit) -> WebContents

        [<Emit"$0.once('paint',$1)">]
        abstract oncePaint : listener:(Event -> Rectangle -> NativeImage -> unit) -> WebContents

        [<Emit"$0.addListener('paint',$1)">]
        abstract addListenerPaint : listener:(Event -> Rectangle -> NativeImage -> unit) -> WebContents

        [<Emit"$0.removeListener('paint',$1)">]
        abstract removeListenerPaint : listener:(Event -> Rectangle -> NativeImage -> unit) -> WebContents

        /// Emitted when a plugin process has crashed.
        [<Emit"$0.on('plugin-crashed',$1)">]
        abstract onPluginCrashed : listener:(Event -> string -> string -> unit) -> WebContents

        [<Emit"$0.once('plugin-crashed',$1)">]
        abstract oncePluginCrashed : listener:(Event -> string -> string -> unit) -> WebContents

        [<Emit"$0.addListener('plugin-crashed',$1)">]
        abstract addListenerPluginCrashed : listener:(Event -> string -> string -> unit) -> WebContents

        [<Emit"$0.removeListener('plugin-crashed',$1)">]
        abstract removeListenerPluginCrashed : listener:(Event -> string -> string -> unit) -> WebContents

        /// Emitted when the preload script preloadPath throws an unhandled exception error.
        [<Emit"$0.on('preload-error',$1)">]
        abstract onPreloadError : listener:(Event -> string -> Error -> unit) -> WebContents

        [<Emit"$0.once('preload-error',$1)">]
        abstract oncePreloadError : listener:(Event -> string -> Error -> unit) -> WebContents

        [<Emit"$0.addListener('preload-error',$1)">]
        abstract addListenerPreloadError : listener:(Event -> string -> Error -> unit) -> WebContents

        [<Emit"$0.removeListener('preload-error',$1)">]
        abstract removeListenerPreloadError : listener:(Event -> string -> Error -> unit) -> WebContents
        ...
        [<Emit"$0.on('remote-get-builtin',$1)">]
        abstract onRemoteGetBuiltin : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.once('remote-get-builtin',$1)">]
        abstract onceRemoteGetBuiltin : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.addListener('remote-get-builtin',$1)">]
        abstract addListenerRemoteGetBuiltin : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.removeListener('remote-get-builtin',$1)">]
        abstract removeListenerRemoteGetBuiltin : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        /// Emitted when remote.getCurrentWebContents() is called in the renderer process.
        /// Calling event.preventDefault() will prevent the object from being returned.
        /// Custom value can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-get-current-web-contents',$1)">]
        abstract onRemoteGetCurrentWebContents : listener:(ReturnValueEvent -> unit) -> WebContents

        [<Emit"$0.once('remote-get-current-web-contents',$1)">]
        abstract onceRemoteGetCurrentWebContents : listener:(ReturnValueEvent -> unit) -> WebContents

        [<Emit"$0.addListener('remote-get-current-web-contents',$1)">]
        abstract addListenerRemoteGetCurrentWebContents : listener:(ReturnValueEvent -> unit) -> WebContents

        [<Emit"$0.removeListener('remote-get-current-web-contents',$1)">]
        abstract removeListenerRemoteGetCurrentWebContents : listener:(ReturnValueEvent -> unit) -> WebContents

        /// Emitted when remote.getCurrentWindow() is called in the renderer process.
        /// Calling event.preventDefault() will prevent the object from being returned.
        /// Custom value can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-get-current-window',$1)">]
        abstract onRemoteGetCurrentWindow : listener:(ReturnValueEvent -> unit) -> WebContents

        [<Emit"$0.once('remote-get-current-window',$1)">]
        abstract onceRemoteGetCurrentWindow : listener:(ReturnValueEvent -> unit) -> WebContents

        [<Emit"$0.addListener('remote-get-current-window',$1)">]
        abstract addListenerRemoteGetCurrentWindow : listener:(ReturnValueEvent -> unit) -> WebContents

        [<Emit"$0.removeListener('remote-get-current-window',$1)">]
        abstract removeListenerRemoteGetCurrentWindow : listener:(ReturnValueEvent -> unit) -> WebContents
        ...
        /// can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-get-global',$1)">]
        abstract onRemoteGetGlobal : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.once('remote-get-global',$1)">]
        abstract onceRemoteGetGlobal : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.addListener('remote-get-global',$1)">]
        abstract addListenerRemoteGetGlobal : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.removeListener('remote-get-global',$1)">]
        abstract removeListenerRemoteGetGlobal : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        /// Emitted when <webview>.getWebContents() is called in the renderer process.
        /// Calling event.preventDefault() will prevent the object from being returned.
        /// Custom value can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-get-guest-web-contents',$1)">]
        abstract onRemoteGetGuestWebContents : listener:(ReturnValueEvent -> WebContents -> unit) -> WebContents

        [<Emit"$0.once('remote-get-guest-web-contents',$1)">]
        abstract onceRemoteGetGuestWebContents : listener:(ReturnValueEvent -> WebContents -> unit) -> WebContents

        [<Emit"$0.addListener('remote-get-guest-web-contents',$1)">]
        abstract addListenerRemoteGetGuestWebContents : listener:(ReturnValueEvent -> WebContents -> unit)
         -> WebContents

        [<Emit"$0.removeListener('remote-get-guest-web-contents',$1)">]
        abstract removeListenerRemoteGetGuestWebContents : listener:(ReturnValueEvent -> WebContents -> unit)
         -> WebContents
        ...
        /// can be returned by setting event.returnValue.
        [<Emit"$0.on('remote-require',$1)">]
        abstract onRemoteRequire : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.once('remote-require',$1)">]
        abstract onceRemoteRequire : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.addListener('remote-require',$1)">]
        abstract addListenerRemoteRequire : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        [<Emit"$0.removeListener('remote-require',$1)">]
        abstract removeListenerRemoteRequire : listener:(ReturnValueEvent -> string -> unit) -> WebContents

        /// Emitted when the unresponsive web page becomes responsive again.
        [<Emit"$0.on('responsive',$1)">]
        abstract onResponsive : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('responsive',$1)">]
        abstract onceResponsive : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('responsive',$1)">]
        abstract addListenerResponsive : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('responsive',$1)">]
        abstract removeListenerResponsive : listener:(Event -> unit) -> WebContents
        ...
        abstract onSelectBluetoothDevice : listener:(Event -> BluetoothDevice [] -> (string -> unit) -> unit)
         -> WebContents

        [<Emit"$0.once('select-bluetooth-device',$1)">]
        abstract onceSelectBluetoothDevice : listener:(Event -> BluetoothDevice [] -> (string -> unit) -> unit)
         -> WebContents

        [<Emit"$0.addListener('select-bluetooth-device',$1)">]
        abstract addListenerSelectBluetoothDevice : listener:(Event -> BluetoothDevice [] -> (string -> unit) -> unit)
         -> WebContents

        [<Emit"$0.removeListener('select-bluetooth-device',$1)">]
        abstract removeListenerSelectBluetoothDevice : listener:(Event -> BluetoothDevice [] -> (string -> unit) -> unit)
         -> WebContents

        /// Emitted when a client certificate is requested. The usage is the same with the
        /// select-client-certificate event of app.
        [<Emit"$0.on('select-client-certificate',$1)">]
        abstract onSelectClientCertificate : listener:(Event -> string -> Certificate [] -> (Certificate -> unit) -> unit)
         -> WebContents

        [<Emit"$0.once('select-client-certificate',$1)">]
        abstract onceSelectClientCertificate : listener:(Event -> string -> Certificate [] -> (Certificate -> unit) -> unit)
         -> WebContents

        [<Emit"$0.addListener('select-client-certificate',$1)">]
        abstract addListenerSelectClientCertificate : listener:(Event -> string -> Certificate [] -> (Certificate -> unit) -> unit)
         -> WebContents

        [<Emit"$0.removeListener('select-client-certificate',$1)">]
        abstract removeListenerSelectClientCertificate : listener:(Event -> string -> Certificate [] -> (Certificate -> unit) -> unit)
         -> WebContents

        /// Emitted when the web page becomes unresponsive.
        [<Emit"$0.on('unresponsive',$1)">]
        abstract onUnresponsive : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('unresponsive',$1)">]
        abstract onceUnresponsive : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('unresponsive',$1)">]
        abstract addListenerUnresponsive : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('unresponsive',$1)">]
        abstract removeListenerUnresponsive : listener:(Event -> unit) -> WebContents

        /// Emitted when mouse moves over a link or the keyboard moves the focus to a link.
        [<Emit"$0.on('update-target-url',$1)">]
        abstract onUpdateTargetUrl : listener:(Event -> string -> unit) -> WebContents

        [<Emit"$0.once('update-target-url',$1)">]
        abstract onceUpdateTargetUrl : listener:(Event -> string -> unit) -> WebContents

        [<Emit"$0.addListener('update-target-url',$1)">]
        abstract addListenerUpdateTargetUrl : listener:(Event -> string -> unit) -> WebContents

        [<Emit"$0.removeListener('update-target-url',$1)">]
        abstract removeListenerUpdateTargetUrl : listener:(Event -> string -> unit) -> WebContents
        ...
        abstract onWillAttachWebview : listener:(Event -> WebPreferences -> obj -> unit) -> WebContents

        [<Emit"$0.once('will-attach-webview',$1)">]
        abstract onceWillAttachWebview : listener:(Event -> WebPreferences -> obj -> unit) -> WebContents

        [<Emit"$0.addListener('will-attach-webview',$1)">]
        abstract addListenerWillAttachWebview : listener:(Event -> WebPreferences -> obj -> unit) -> WebContents

        [<Emit"$0.removeListener('will-attach-webview',$1)">]
        abstract removeListenerWillAttachWebview : listener:(Event -> WebPreferences -> obj -> unit) -> WebContents
        ...
        abstract onWillNavigate : listener:(Event -> string -> unit) -> WebContents

        [<Emit"$0.once('will-navigate',$1)">]
        abstract onceWillNavigate : listener:(Event -> string -> unit) -> WebContents

        [<Emit"$0.addListener('will-navigate',$1)">]
        abstract addListenerWillNavigate : listener:(Event -> string -> unit) -> WebContents

        [<Emit"$0.removeListener('will-navigate',$1)">]
        abstract removeListenerWillNavigate : listener:(Event -> string -> unit) -> WebContents
        ...
        abstract onWillPreventUnload : listener:(Event -> unit) -> WebContents

        [<Emit"$0.once('will-prevent-unload',$1)">]
        abstract onceWillPreventUnload : listener:(Event -> unit) -> WebContents

        [<Emit"$0.addListener('will-prevent-unload',$1)">]
        abstract addListenerWillPreventUnload : listener:(Event -> unit) -> WebContents

        [<Emit"$0.removeListener('will-prevent-unload',$1)">]
        abstract removeListenerWillPreventUnload : listener:(Event -> unit) -> WebContents
        ...
        abstract onWillRedirect : listener:(Event -> string -> bool -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.once('will-redirect',$1)">]
        abstract onceWillRedirect : listener:(Event -> string -> bool -> bool -> int -> int -> unit) -> WebContents

        [<Emit"$0.addListener('will-redirect',$1)">]
        abstract addListenerWillRedirect : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents

        [<Emit"$0.removeListener('will-redirect',$1)">]
        abstract removeListenerWillRedirect : listener:(Event -> string -> bool -> bool -> int -> int -> unit)
         -> WebContents
        ...
        /// Promise.
        abstract executeJavaScript : code:string * ?userGesture:bool * ?callback:(obj option -> unit)
         -> Promise<obj option>
    ...
    type WebFrame =
        ...
        abstract executeJavaScriptInIsolatedWorld : worldId:int * scripts:WebSource [] * ?userGesture:bool * ?callback:(obj option -> unit)
         -> unit
    ...
    type WebRequest =
        ...
        /// The listener will be called with listener(details) when a server initiated
        /// redirect is about to occur.
        abstract onBeforeRedirect : filter:OnBeforeRedirectFilter * listener:(OnBeforeRedirectDetails -> unit) option
         -> unit
        ...
        abstract onBeforeRequest : listener:(OnBeforeRequestDetails -> (OnBeforeRequestResponse -> unit) -> unit) option
         -> unit

        /// The listener will be called with listener(details, callback) when a request is
        /// about to occur. The uploadData is an array of UploadData objects. The callback
        /// has to be called with an response object.
        abstract onBeforeRequest : filter:OnBeforeRequestFilter * listener:(OnBeforeRequestDetails -> (OnBeforeRequestResponse -> unit) -> unit) option
         -> unit
        ...
        /// has to be called with an response object.
        abstract onBeforeSendHeaders : filter:OnBeforeSendHeadersFilter * listener:(OnBeforeSendHeadersDetails -> (OnBeforeSendHeadersResponse -> unit) -> unit) option
         -> unit
        ...
        /// connection is made to the server, but before any http data is sent. The callback
        /// has to be called with an response object.
        abstract onBeforeSendHeaders : listener:(OnBeforeSendHeadersDetails -> (OnBeforeSendHeadersResponse -> unit) -> unit) option
         -> unit
        ...
        /// The listener will be called with listener(details) when an error occurs.
        abstract onErrorOccurred : filter:OnErrorOccurredFilter * listener:(OnErrorOccurredDetails -> unit) option
         -> unit
        ...
        /// response object.
        abstract onHeadersReceived : filter:OnHeadersReceivedFilter * listener:(OnHeadersReceivedDetails -> (OnHeadersReceivedResponse -> unit) -> unit) option
         -> unit

        /// The listener will be called with listener(details, callback) when HTTP response
        /// headers of a request have been received. The callback has to be called with an
        /// response object.
        abstract onHeadersReceived : listener:(OnHeadersReceivedDetails -> (OnHeadersReceivedResponse -> unit) -> unit) option
         -> unit
        ...
        /// response body is received. For HTTP requests, this means that the status line
        /// and response headers are available.
        abstract onResponseStarted : filter:OnResponseStartedFilter * listener:(OnResponseStartedDetails -> unit) option
         -> unit
    ...
    module NodeExtensions =
        ...
        type Process =
            ...
            [<Emit"$0.on('loaded',$1)">]
            abstract onLoaded : listener:(Event -> unit) -> Process

            [<Emit"$0.once('loaded',$1)">]
            abstract onceLoaded : listener:(Event -> unit) -> Process

            [<Emit"$0.addListener('loaded',$1)">]
            abstract addListenerLoaded : listener:(Event -> unit) -> Process

            [<Emit"$0.removeListener('loaded',$1)">]
            abstract removeListenerLoaded : listener:(Event -> unit) -> Process
