...
module rec Electron =
    ...
    type App =
        ...
        [<Emit"$0.on('ready',$1)">]
        abstract onReady : listener:(Event -> obj -> unit) -> App

        /// See onReady.
        [<Emit"$0.once('ready',$1)">]
        abstract onceReady : listener:(Event -> obj -> unit) -> App

        /// See onReady.
        [<Emit"$0.addListener('ready',$1)">]
        abstract addListenerReady : listener:(Event -> obj -> unit) -> App

        /// See onReady.
        [<Emit"$0.removeListener('ready',$1)">]
        abstract removeListenerReady : listener:(Event -> obj -> unit) -> App
        ...
        abstract onContinueActivity : listener:(Event -> string -> obj -> unit) -> App

        /// See onContinueActivity.
        [<Emit"$0.once('continue-activity',$1)">]
        abstract onceContinueActivity : listener:(Event -> string -> obj -> unit) -> App

        /// See onContinueActivity.
        [<Emit"$0.addListener('continue-activity',$1)">]
        abstract addListenerContinueActivity : listener:(Event -> string -> obj -> unit) -> App

        /// See onContinueActivity.
        [<Emit"$0.removeListener('continue-activity',$1)">]
        abstract removeListenerContinueActivity : listener:(Event -> string -> obj -> unit) -> App
        ...
        abstract onActivityWasContinued : listener:(Event -> string -> obj -> unit) -> App

        /// See onActivityWasContinued.
        [<Emit"$0.once('activity-was-continued',$1)">]
        abstract onceActivityWasContinued : listener:(Event -> string -> obj -> unit) -> App

        /// See onActivityWasContinued.
        [<Emit"$0.addListener('activity-was-continued',$1)">]
        abstract addListenerActivityWasContinued : listener:(Event -> string -> obj -> unit) -> App

        /// See onActivityWasContinued.
        [<Emit"$0.removeListener('activity-was-continued',$1)">]
        abstract removeListenerActivityWasContinued : listener:(Event -> string -> obj -> unit) -> App
        ...
        abstract onBrowserWindowCreated : listener:(unit -> BrowserWindow -> unit) -> App

        /// See onBrowserWindowCreated.
        [<Emit"$0.once('browser-window-created',$1)">]
        abstract onceBrowserWindowCreated : listener:(unit -> BrowserWindow -> unit) -> App

        /// See onBrowserWindowCreated.
        [<Emit"$0.addListener('browser-window-created',$1)">]
        abstract addListenerBrowserWindowCreated : listener:(unit -> BrowserWindow -> unit) -> App

        /// See onBrowserWindowCreated.
        [<Emit"$0.removeListener('browser-window-created',$1)">]
        abstract removeListenerBrowserWindowCreated : listener:(unit -> BrowserWindow -> unit) -> App
        ...
        abstract onWebContentsCreated : listener:(unit -> WebContents -> unit) -> App

        /// See onWebContentsCreated.
        [<Emit"$0.once('web-contents-created',$1)">]
        abstract onceWebContentsCreated : listener:(unit -> WebContents -> unit) -> App

        /// See onWebContentsCreated.
        [<Emit"$0.addListener('web-contents-created',$1)">]
        abstract addListenerWebContentsCreated : listener:(unit -> WebContents -> unit) -> App

        /// See onWebContentsCreated.
        [<Emit"$0.removeListener('web-contents-created',$1)">]
        abstract removeListenerWebContentsCreated : listener:(unit -> WebContents -> unit) -> App
        ...
        ///   - webContents
        ///   - killed
        [<Emit"$0.on('renderer-process-crashed',$1)">]
        abstract onRendererProcessCrashed : listener:(Event -> WebContents -> bool -> unit) -> App

        /// See onRendererProcessCrashed.
        [<Emit"$0.once('renderer-process-crashed',$1)">]
        abstract onceRendererProcessCrashed : listener:(Event -> WebContents -> bool -> unit) -> App

        /// See onRendererProcessCrashed.
        [<Emit"$0.addListener('renderer-process-crashed',$1)">]
        abstract addListenerRendererProcessCrashed : listener:(Event -> WebContents -> bool -> unit) -> App

        /// See onRendererProcessCrashed.
        [<Emit"$0.removeListener('renderer-process-crashed',$1)">]
        abstract removeListenerRendererProcessCrashed : listener:(Event -> WebContents -> bool -> unit) -> App
        ...
        abstract addListenerSessionCreated : listener:(Event -> Session -> unit) -> App

        /// See onSessionCreated.
        [<Emit"$0.removeListener('session-created',$1)">]
        abstract removeListenerSessionCreated : listener:(Event -> Session -> unit) -> App
    ...
    type AutoUpdater =
        ...
        abstract onCheckingForUpdate : listener:(unit -> unit) -> AutoUpdater

        /// See onCheckingForUpdate.
        [<Emit"$0.once('checking-for-update',$1)">]
        abstract onceCheckingForUpdate : listener:(unit -> unit) -> AutoUpdater

        /// See onCheckingForUpdate.
        [<Emit"$0.addListener('checking-for-update',$1)">]
        abstract addListenerCheckingForUpdate : listener:(unit -> unit) -> AutoUpdater

        /// See onCheckingForUpdate.
        [<Emit"$0.removeListener('checking-for-update',$1)">]
        abstract removeListenerCheckingForUpdate : listener:(unit -> unit) -> AutoUpdater

        /// Emitted when there is an available update. The update is downloaded
        /// automatically.
        [<Emit"$0.on('update-available',$1)">]
        abstract onUpdateAvailable : listener:(unit -> unit) -> AutoUpdater

        /// See onUpdateAvailable.
        [<Emit"$0.once('update-available',$1)">]
        abstract onceUpdateAvailable : listener:(unit -> unit) -> AutoUpdater

        /// See onUpdateAvailable.
        [<Emit"$0.addListener('update-available',$1)">]
        abstract addListenerUpdateAvailable : listener:(unit -> unit) -> AutoUpdater

        /// See onUpdateAvailable.
        [<Emit"$0.removeListener('update-available',$1)">]
        abstract removeListenerUpdateAvailable : listener:(unit -> unit) -> AutoUpdater

        /// Emitted when there is no available update.
        [<Emit"$0.on('update-not-available',$1)">]
        abstract onUpdateNotAvailable : listener:(unit -> unit) -> AutoUpdater

        /// See onUpdateNotAvailable.
        [<Emit"$0.once('update-not-available',$1)">]
        abstract onceUpdateNotAvailable : listener:(unit -> unit) -> AutoUpdater

        /// See onUpdateNotAvailable.
        [<Emit"$0.addListener('update-not-available',$1)">]
        abstract addListenerUpdateNotAvailable : listener:(unit -> unit) -> AutoUpdater

        /// See onUpdateNotAvailable.
        [<Emit"$0.removeListener('update-not-available',$1)">]
        abstract removeListenerUpdateNotAvailable : listener:(unit -> unit) -> AutoUpdater
        ...
        abstract onBeforeQuitForUpdate : listener:(unit -> unit) -> AutoUpdater

        /// See onBeforeQuitForUpdate.
        [<Emit"$0.once('before-quit-for-update',$1)">]
        abstract onceBeforeQuitForUpdate : listener:(unit -> unit) -> AutoUpdater

        /// See onBeforeQuitForUpdate.
        [<Emit"$0.addListener('before-quit-for-update',$1)">]
        abstract addListenerBeforeQuitForUpdate : listener:(unit -> unit) -> AutoUpdater

        /// See onBeforeQuitForUpdate.
        [<Emit"$0.removeListener('before-quit-for-update',$1)">]
        abstract removeListenerBeforeQuitForUpdate : listener:(unit -> unit) -> AutoUpdater
    ...
    type BrowserWindow =
        ...
        [<Emit"$0.on('swipe',$1)">]
        abstract onSwipe : listener:(Event -> SwipeDirection -> unit) -> BrowserWindow

        /// See onSwipe.
        [<Emit"$0.once('swipe',$1)">]
        abstract onceSwipe : listener:(Event -> SwipeDirection -> unit) -> BrowserWindow

        /// See onSwipe.
        [<Emit"$0.addListener('swipe',$1)">]
        abstract addListenerSwipe : listener:(Event -> SwipeDirection -> unit) -> BrowserWindow

        /// See onSwipe.
        [<Emit"$0.removeListener('swipe',$1)">]
        abstract removeListenerSwipe : listener:(Event -> SwipeDirection -> unit) -> BrowserWindow
    ...
    type ClientRequest =
        ...
        [<Emit"$0.on('finish',$1)">]
        abstract onFinish : listener:(unit -> unit) -> ClientRequest

        /// See onFinish.
        [<Emit"$0.once('finish',$1)">]
        abstract onceFinish : listener:(unit -> unit) -> ClientRequest

        /// See onFinish.
        [<Emit"$0.addListener('finish',$1)">]
        abstract addListenerFinish : listener:(unit -> unit) -> ClientRequest

        /// See onFinish.
        [<Emit"$0.removeListener('finish',$1)">]
        abstract removeListenerFinish : listener:(unit -> unit) -> ClientRequest

        /// Emitted when the request is aborted. Will not be fired if the request is
        /// already closed.
        [<Emit"$0.on('abort',$1)">]
        abstract onAbort : listener:(unit -> unit) -> ClientRequest

        /// See onAbort.
        [<Emit"$0.once('abort',$1)">]
        abstract onceAbort : listener:(unit -> unit) -> ClientRequest

        /// See onAbort.
        [<Emit"$0.addListener('abort',$1)">]
        abstract addListenerAbort : listener:(unit -> unit) -> ClientRequest

        /// See onAbort.
        [<Emit"$0.removeListener('abort',$1)">]
        abstract removeListenerAbort : listener:(unit -> unit) -> ClientRequest
        ...
        [<Emit"$0.on('close',$1)">]
        abstract onClose : listener:(unit -> unit) -> ClientRequest

        /// See onClose.
        [<Emit"$0.once('close',$1)">]
        abstract onceClose : listener:(unit -> unit) -> ClientRequest

        /// See onClose.
        [<Emit"$0.addListener('close',$1)">]
        abstract addListenerClose : listener:(unit -> unit) -> ClientRequest

        /// See onClose.
        [<Emit"$0.removeListener('close',$1)">]
        abstract removeListenerClose : listener:(unit -> unit) -> ClientRequest
    ...
    type ClientRequestStatic =
        ...
        [<EmitConstructor>]
        abstract Create : options:string -> ClientRequest

        [<EmitConstructor>]
        abstract Create : options:ClientRequestOptions -> ClientRequest
    ...
    type Dialog =
        ...
        /// certificate.
        abstract showCertificateTrustDialog : browserWindow:BrowserWindow * options:CertificateTrustDialogOptions
         -> Promise<unit>
    ...
    type IncomingMessage =
        ...
        [<Emit"$0.on('end',$1)">]
        abstract onEnd : listener:(unit -> unit) -> IncomingMessage

        /// See onEnd.
        [<Emit"$0.once('end',$1)">]
        abstract onceEnd : listener:(unit -> unit) -> IncomingMessage

        /// See onEnd.
        [<Emit"$0.addListener('end',$1)">]
        abstract addListenerEnd : listener:(unit -> unit) -> IncomingMessage

        /// See onEnd.
        [<Emit"$0.removeListener('end',$1)">]
        abstract removeListenerEnd : listener:(unit -> unit) -> IncomingMessage

        /// Emitted when a request has been canceled during an ongoing HTTP
        /// transaction.
        [<Emit"$0.on('aborted',$1)">]
        abstract onAborted : listener:(unit -> unit) -> IncomingMessage

        /// See onAborted.
        [<Emit"$0.once('aborted',$1)">]
        abstract onceAborted : listener:(unit -> unit) -> IncomingMessage

        /// See onAborted.
        [<Emit"$0.addListener('aborted',$1)">]
        abstract addListenerAborted : listener:(unit -> unit) -> IncomingMessage

        /// See onAborted.
        [<Emit"$0.removeListener('aborted',$1)">]
        abstract removeListenerAborted : listener:(unit -> unit) -> IncomingMessage
        ...
        /// request object.
        [<Emit"$0.on('error',$1)">]
        abstract onError : listener:(Error -> unit) -> IncomingMessage

        /// See onError.
        [<Emit"$0.once('error',$1)">]
        abstract onceError : listener:(Error -> unit) -> IncomingMessage

        /// See onError.
        [<Emit"$0.addListener('error',$1)">]
        abstract addListenerError : listener:(Error -> unit) -> IncomingMessage

        /// See onError.
        [<Emit"$0.removeListener('error',$1)">]
        abstract removeListenerError : listener:(Error -> unit) -> IncomingMessage
    ...
    type PowerMonitor =
        ...
        [<Emit"$0.on('suspend',$1)">]
        abstract onSuspend : listener:(unit -> unit) -> PowerMonitor

        /// See onSuspend.
        [<Emit"$0.once('suspend',$1)">]
        abstract onceSuspend : listener:(unit -> unit) -> PowerMonitor

        /// See onSuspend.
        [<Emit"$0.addListener('suspend',$1)">]
        abstract addListenerSuspend : listener:(unit -> unit) -> PowerMonitor

        /// See onSuspend.
        [<Emit"$0.removeListener('suspend',$1)">]
        abstract removeListenerSuspend : listener:(unit -> unit) -> PowerMonitor

        /// Emitted when system is resuming.
        [<Emit"$0.on('resume',$1)">]
        abstract onResume : listener:(unit -> unit) -> PowerMonitor

        /// See onResume.
        [<Emit"$0.once('resume',$1)">]
        abstract onceResume : listener:(unit -> unit) -> PowerMonitor

        /// See onResume.
        [<Emit"$0.addListener('resume',$1)">]
        abstract addListenerResume : listener:(unit -> unit) -> PowerMonitor

        /// See onResume.
        [<Emit"$0.removeListener('resume',$1)">]
        abstract removeListenerResume : listener:(unit -> unit) -> PowerMonitor

        /// [Windows] Emitted when the system changes to AC power.
        [<Emit"$0.on('on-ac',$1)">]
        abstract onOnAc : listener:(unit -> unit) -> PowerMonitor

        /// See onOnAc.
        [<Emit"$0.once('on-ac',$1)">]
        abstract onceOnAc : listener:(unit -> unit) -> PowerMonitor

        /// See onOnAc.
        [<Emit"$0.addListener('on-ac',$1)">]
        abstract addListenerOnAc : listener:(unit -> unit) -> PowerMonitor

        /// See onOnAc.
        [<Emit"$0.removeListener('on-ac',$1)">]
        abstract removeListenerOnAc : listener:(unit -> unit) -> PowerMonitor

        /// [Windows] Emitted when system changes to battery power.
        [<Emit"$0.on('on-battery',$1)">]
        abstract onOnBattery : listener:(unit -> unit) -> PowerMonitor

        /// See onOnBattery.
        [<Emit"$0.once('on-battery',$1)">]
        abstract onceOnBattery : listener:(unit -> unit) -> PowerMonitor

        /// See onOnBattery.
        [<Emit"$0.addListener('on-battery',$1)">]
        abstract addListenerOnBattery : listener:(unit -> unit) -> PowerMonitor

        /// See onOnBattery.
        [<Emit"$0.removeListener('on-battery',$1)">]
        abstract removeListenerOnBattery : listener:(unit -> unit) -> PowerMonitor
        ...
        abstract onShutdown : listener:(unit -> unit) -> PowerMonitor

        /// See onShutdown.
        [<Emit"$0.once('shutdown',$1)">]
        abstract onceShutdown : listener:(unit -> unit) -> PowerMonitor

        /// See onShutdown.
        [<Emit"$0.addListener('shutdown',$1)">]
        abstract addListenerShutdown : listener:(unit -> unit) -> PowerMonitor

        /// See onShutdown.
        [<Emit"$0.removeListener('shutdown',$1)">]
        abstract removeListenerShutdown : listener:(unit -> unit) -> PowerMonitor

        /// [macOS, Windows] Emitted when the system is about to lock the screen.
        [<Emit"$0.on('lock-screen',$1)">]
        abstract onLockScreen : listener:(unit -> unit) -> PowerMonitor

        /// See onLockScreen.
        [<Emit"$0.once('lock-screen',$1)">]
        abstract onceLockScreen : listener:(unit -> unit) -> PowerMonitor

        /// See onLockScreen.
        [<Emit"$0.addListener('lock-screen',$1)">]
        abstract addListenerLockScreen : listener:(unit -> unit) -> PowerMonitor

        /// See onLockScreen.
        [<Emit"$0.removeListener('lock-screen',$1)">]
        abstract removeListenerLockScreen : listener:(unit -> unit) -> PowerMonitor

        /// [macOS, Windows] Emitted as soon as the systems screen is unlocked.
        [<Emit"$0.on('unlock-screen',$1)">]
        abstract onUnlockScreen : listener:(unit -> unit) -> PowerMonitor

        /// See onUnlockScreen.
        [<Emit"$0.once('unlock-screen',$1)">]
        abstract onceUnlockScreen : listener:(unit -> unit) -> PowerMonitor

        /// See onUnlockScreen.
        [<Emit"$0.addListener('unlock-screen',$1)">]
        abstract addListenerUnlockScreen : listener:(unit -> unit) -> PowerMonitor

        /// See onUnlockScreen.
        [<Emit"$0.removeListener('unlock-screen',$1)">]
        abstract removeListenerUnlockScreen : listener:(unit -> unit) -> PowerMonitor
    ...
    type Process =
        ...
        [<Emit"$0.on('loaded',$1)">]
        abstract onLoaded : listener:(unit -> unit) -> Process

        /// See onLoaded.
        [<Emit"$0.once('loaded',$1)">]
        abstract onceLoaded : listener:(unit -> unit) -> Process

        /// See onLoaded.
        [<Emit"$0.addListener('loaded',$1)">]
        abstract addListenerLoaded : listener:(unit -> unit) -> Process

        /// See onLoaded.
        [<Emit"$0.removeListener('loaded',$1)">]
        abstract removeListenerLoaded : listener:(unit -> unit) -> Process
    ...
    type Protocol =
        ...
        abstract registerFileProtocol : scheme:string * handler:(RegisterFileProtocolRequest -> (obj -> unit) -> unit) * ?completion:(Error option -> unit)
         -> unit
        ...
        /// callback signature.
        abstract registerBufferProtocol : scheme:string * handler:(RegisterBufferProtocolRequest -> (Buffer -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        /// The usage is the same with registerFileProtocol, except for the handler's
        /// callback signature.
        abstract registerBufferProtocol : scheme:string * handler:(RegisterBufferProtocolRequest -> (MimeTypedBuffer -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        /// The usage is the same with registerFileProtocol, except for the handler's
        /// callback signature.
        abstract registerStringProtocol : scheme:string * handler:(RegisterStringProtocolRequest -> (string -> unit) -> unit) * ?completion:(Error option -> unit)
         -> unit
        ...
        /// The usage is the same with registerFileProtocol, except for the handler's
        /// callback signature.
        abstract registerStringProtocol : scheme:string * handler:(RegisterStringProtocolRequest -> (MimeTypedBuffer -> unit) -> unit) * ?completion:(Error option -> unit)
         -> unit
        ...
        abstract registerHttpProtocol : scheme:string * handler:(RegisterHttpProtocolRequest -> (RedirectRequest -> unit) -> unit) * ?completion:(Error option -> unit)
         -> unit
        ...
        abstract registerStreamProtocol : scheme:string * handler:(RegisterStreamProtocolRequest -> (Node.Stream.Readable<'a> -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        /// The usage is similar to the other register{Any}Protocol, except for the
        /// handler's callback signature.
        abstract registerStreamProtocol : scheme:string * handler:(RegisterStreamProtocolRequest -> (StreamProtocolResponse<'a> -> unit) -> unit) * ?completion:(Error -> unit)
         -> unit
        ...
        abstract interceptFileProtocol : scheme:string * handler:(InterceptFileProtocolRequest -> (string -> unit) -> unit) * ?completion:(Error option -> unit)
         -> unit

        /// Intercepts `scheme` protocol and uses `handler` as the protocol's new
        /// handler which sends a string as a response.
        abstract interceptStringProtocol : scheme:string * handler:(InterceptStringProtocolRequest -> (string -> unit) -> unit) * ?completion:(Error option -> unit)
         -> unit

        /// Intercepts `scheme` protocol and uses `handler` as the protocol's new
        /// handler which sends a Buffer as a response.
        abstract interceptBufferProtocol : scheme:string * handler:(InterceptBufferProtocolRequest -> (Buffer -> unit) -> unit) * ?completion:(Error option -> unit)
         -> unit

        /// Intercepts `scheme` protocol and uses `handler` as the protocol's new
        /// handler which sends a new HTTP request as a response.
        abstract interceptHttpProtocol : scheme:string * handler:(InterceptHttpProtocolRequest -> (RedirectRequest -> unit) -> unit) * ?completion:(Error option -> unit)
         -> unit
    ...
    type Screen =
        ...
        abstract onDisplayMetricsChanged : listener:(Event -> Display -> DisplayMetricChangeType [] -> unit) -> Screen

        /// See onDisplayMetricsChanged.
        [<Emit"$0.once('display-metrics-changed',$1)">]
        abstract onceDisplayMetricsChanged : listener:(Event -> Display -> DisplayMetricChangeType [] -> unit) -> Screen

        /// See onDisplayMetricsChanged.
        [<Emit"$0.addListener('display-metrics-changed',$1)">]
        abstract addListenerDisplayMetricsChanged : listener:(Event -> Display -> DisplayMetricChangeType [] -> unit)
         -> Screen

        /// See onDisplayMetricsChanged.
        [<Emit"$0.removeListener('display-metrics-changed',$1)">]
        abstract removeListenerDisplayMetricsChanged : listener:(Event -> Display -> DisplayMetricChangeType [] -> unit)
         -> Screen
    ...
    [<StringEnum; RequireQualifiedAccess>]
    type PermissionCheckHandlerPermission = Media
    ...
    type Session =
        ...
        abstract setPermissionRequestHandler : handler:(WebContents -> PermissionRequestHandlerPermission -> (bool -> unit) -> PermissionRequestHandlerDetails -> unit) option
         -> unit
        ...
        /// Please note that if the request comes from a subframe you should use
        /// PermissionRequestHandlerDetails.requestingUrl to check the request origin.
        abstract setPermissionCheckHandler : handler:(WebContents -> PermissionCheckHandlerPermission -> string -> PermissionCheckHandlerDetails -> bool) option
         -> unit
    ...
    type Tray =
        ...
        abstract onBalloonShow : listener:(unit -> unit) -> Tray

        /// See onBalloonShow.
        [<Emit"$0.once('balloon-show',$1)">]
        abstract onceBalloonShow : listener:(unit -> unit) -> Tray

        /// See onBalloonShow.
        [<Emit"$0.addListener('balloon-show',$1)">]
        abstract addListenerBalloonShow : listener:(unit -> unit) -> Tray

        /// See onBalloonShow.
        [<Emit"$0.removeListener('balloon-show',$1)">]
        abstract removeListenerBalloonShow : listener:(unit -> unit) -> Tray

        /// [Windows] Emitted when the tray balloon is clicked.
        [<Emit"$0.on('balloon-click',$1)">]
        abstract onBalloonClick : listener:(unit -> unit) -> Tray

        /// See onBalloonClick.
        [<Emit"$0.once('balloon-click',$1)">]
        abstract onceBalloonClick : listener:(unit -> unit) -> Tray

        /// See onBalloonClick.
        [<Emit"$0.addListener('balloon-click',$1)">]
        abstract addListenerBalloonClick : listener:(unit -> unit) -> Tray

        /// See onBalloonClick.
        [<Emit"$0.removeListener('balloon-click',$1)">]
        abstract removeListenerBalloonClick : listener:(unit -> unit) -> Tray

        /// [Windows] Emitted when the tray balloon is closed because of timeout or
        /// user manually closes it.
        [<Emit"$0.on('balloon-closed',$1)">]
        abstract onBalloonClosed : listener:(unit -> unit) -> Tray

        /// See onBalloonClosed.
        [<Emit"$0.once('balloon-closed',$1)">]
        abstract onceBalloonClosed : listener:(unit -> unit) -> Tray

        /// See onBalloonClosed.
        [<Emit"$0.addListener('balloon-closed',$1)">]
        abstract addListenerBalloonClosed : listener:(unit -> unit) -> Tray

        /// See onBalloonClosed.
        [<Emit"$0.removeListener('balloon-closed',$1)">]
        abstract removeListenerBalloonClosed : listener:(unit -> unit) -> Tray

        /// [macOS] Emitted when any dragged items are dropped on the tray icon.
        [<Emit"$0.on('drop',$1)">]
        abstract onDrop : listener:(unit -> unit) -> Tray

        /// See onDrop.
        [<Emit"$0.once('drop',$1)">]
        abstract onceDrop : listener:(unit -> unit) -> Tray

        /// See onDrop.
        [<Emit"$0.addListener('drop',$1)">]
        abstract addListenerDrop : listener:(unit -> unit) -> Tray

        /// See onDrop.
        [<Emit"$0.removeListener('drop',$1)">]
        abstract removeListenerDrop : listener:(unit -> unit) -> Tray
        ...
        abstract onDragEnter : listener:(unit -> unit) -> Tray

        /// See onDragEnter.
        [<Emit"$0.once('drag-enter',$1)">]
        abstract onceDragEnter : listener:(unit -> unit) -> Tray

        /// See onDragEnter.
        [<Emit"$0.addListener('drag-enter',$1)">]
        abstract addListenerDragEnter : listener:(unit -> unit) -> Tray

        /// See onDragEnter.
        [<Emit"$0.removeListener('drag-enter',$1)">]
        abstract removeListenerDragEnter : listener:(unit -> unit) -> Tray

        /// [macOS] Emitted when a drag operation exits the tray icon.
        [<Emit"$0.on('drag-leave',$1)">]
        abstract onDragLeave : listener:(unit -> unit) -> Tray

        /// See onDragLeave.
        [<Emit"$0.once('drag-leave',$1)">]
        abstract onceDragLeave : listener:(unit -> unit) -> Tray

        /// See onDragLeave.
        [<Emit"$0.addListener('drag-leave',$1)">]
        abstract addListenerDragLeave : listener:(unit -> unit) -> Tray

        /// See onDragLeave.
        [<Emit"$0.removeListener('drag-leave',$1)">]
        abstract removeListenerDragLeave : listener:(unit -> unit) -> Tray

        /// [macOS] Emitted when a drag operation ends on the tray or ends at another
        /// location.
        [<Emit"$0.on('drag-end',$1)">]
        abstract onDragEnd : listener:(unit -> unit) -> Tray

        /// See onDragEnd.
        [<Emit"$0.once('drag-end',$1)">]
        abstract onceDragEnd : listener:(unit -> unit) -> Tray

        /// See onDragEnd.
        [<Emit"$0.addListener('drag-end',$1)">]
        abstract addListenerDragEnd : listener:(unit -> unit) -> Tray

        /// See onDragEnd.
        [<Emit"$0.removeListener('drag-end',$1)">]
        abstract removeListenerDragEnd : listener:(unit -> unit) -> Tray
    ...
    type TrayStatic =
        ...
        [<EmitConstructor>]
        abstract Create : image:NativeImage -> Tray

        /// Creates a new tray icon associated with the image.
        [<EmitConstructor>]
        abstract Create : image:string -> Tray
    ...
    type WebContents =
        ...
        abstract onDidStartLoading : listener:(unit -> unit) -> WebContents

        /// See onDidStartLoading.
        [<Emit"$0.once('did-start-loading',$1)">]
        abstract onceDidStartLoading : listener:(unit -> unit) -> WebContents

        /// See onDidStartLoading.
        [<Emit"$0.addListener('did-start-loading',$1)">]
        abstract addListenerDidStartLoading : listener:(unit -> unit) -> WebContents

        /// See onDidStartLoading.
        [<Emit"$0.removeListener('did-start-loading',$1)">]
        abstract removeListenerDidStartLoading : listener:(unit -> unit) -> WebContents

        /// Corresponds to the points in time when the spinner of the tab stopped
        /// spinning.
        [<Emit"$0.on('did-stop-loading',$1)">]
        abstract onDidStopLoading : listener:(unit -> unit) -> WebContents

        /// See onDidStopLoading.
        [<Emit"$0.once('did-stop-loading',$1)">]
        abstract onceDidStopLoading : listener:(unit -> unit) -> WebContents

        /// See onDidStopLoading.
        [<Emit"$0.addListener('did-stop-loading',$1)">]
        abstract addListenerDidStopLoading : listener:(unit -> unit) -> WebContents

        /// See onDidStopLoading.
        [<Emit"$0.removeListener('did-stop-loading',$1)">]
        abstract removeListenerDidStopLoading : listener:(unit -> unit) -> WebContents
        ...
        /// Emitted when the web page becomes unresponsive.
        [<Emit"$0.on('unresponsive',$1)">]
        abstract onUnresponsive : listener:(unit -> unit) -> WebContents

        /// See onUnresponsive.
        [<Emit"$0.once('unresponsive',$1)">]
        abstract onceUnresponsive : listener:(unit -> unit) -> WebContents

        /// See onUnresponsive.
        [<Emit"$0.addListener('unresponsive',$1)">]
        abstract addListenerUnresponsive : listener:(unit -> unit) -> WebContents

        /// See onUnresponsive.
        [<Emit"$0.removeListener('unresponsive',$1)">]
        abstract removeListenerUnresponsive : listener:(unit -> unit) -> WebContents

        /// Emitted when the unresponsive web page becomes responsive again.
        [<Emit"$0.on('responsive',$1)">]
        abstract onResponsive : listener:(unit -> unit) -> WebContents

        /// See onResponsive.
        [<Emit"$0.once('responsive',$1)">]
        abstract onceResponsive : listener:(unit -> unit) -> WebContents

        /// See onResponsive.
        [<Emit"$0.addListener('responsive',$1)">]
        abstract addListenerResponsive : listener:(unit -> unit) -> WebContents

        /// See onResponsive.
        [<Emit"$0.removeListener('responsive',$1)">]
        abstract removeListenerResponsive : listener:(unit -> unit) -> WebContents
        ...
        abstract onDestroyed : listener:(unit -> unit) -> WebContents

        /// See onDestroyed.
        [<Emit"$0.once('destroyed',$1)">]
        abstract onceDestroyed : listener:(unit -> unit) -> WebContents

        /// See onDestroyed.
        [<Emit"$0.addListener('destroyed',$1)">]
        abstract addListenerDestroyed : listener:(unit -> unit) -> WebContents

        /// See onDestroyed.
        [<Emit"$0.removeListener('destroyed',$1)">]
        abstract removeListenerDestroyed : listener:(unit -> unit) -> WebContents
        ...
        /// Emitted when the window enters a full-screen state triggered by HTML API.
        [<Emit"$0.on('enter-html-full-screen',$1)">]
        abstract onEnterHtmlFullScreen : listener:(Event -> unit) -> WebContents

        /// See onEnterHtmlFullScreen.
        [<Emit"$0.once('enter-html-full-screen',$1)">]
        abstract onceEnterHtmlFullScreen : listener:(Event -> unit) -> WebContents

        /// See onEnterHtmlFullScreen.
        [<Emit"$0.addListener('enter-html-full-screen',$1)">]
        abstract addEnterHtmlFullScreen : listener:(Event -> unit) -> WebContents

        /// See onEnterHtmlFullScreen.
        [<Emit"$0.removeListener('enter-html-full-screen',$1)">]
        abstract removeEnterHtmlFullScreen : listener:(Event -> unit) -> WebContents

        /// Emitted when the window leaves a full-screen state triggered by HTML API.
        [<Emit"$0.on('leave-html-full-screen',$1)">]
        abstract onLeaveHtmlFullScreen : listener:(Event -> unit) -> WebContents

        /// See onLeaveHtmlFullScreen.
        [<Emit"$0.once('leave-html-full-screen',$1)">]
        abstract onceLeaveHtmlFullScreen : listener:(Event -> unit) -> WebContents

        /// See onLeaveHtmlFullScreen.
        [<Emit"$0.addListener('leave-html-full-screen',$1)">]
        abstract addLeaveHtmlFullScreen : listener:(Event -> unit) -> WebContents

        /// See onLeaveHtmlFullScreen.
        [<Emit"$0.removeListener('leave-html-full-screen',$1)">]
        abstract removeLeaveHtmlFullScreen : listener:(Event -> unit) -> WebContents

        /// Emitted when DevTools is opened.
        [<Emit"$0.on('devtools-opened',$1)">]
        abstract onDevtoolsOpened : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsOpened.
        [<Emit"$0.once('devtools-opened',$1)">]
        abstract onceDevtoolsOpened : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsOpened.
        [<Emit"$0.addListener('devtools-opened',$1)">]
        abstract addListenerDevtoolsOpened : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsOpened.
        [<Emit"$0.removeListener('devtools-opened',$1)">]
        abstract removeListenerDevtoolsOpened : listener:(unit -> unit) -> WebContents

        /// Emitted when DevTools is closed.
        [<Emit"$0.on('devtools-closed',$1)">]
        abstract onDevtoolsClosed : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsClosed.
        [<Emit"$0.once('devtools-closed',$1)">]
        abstract onceDevtoolsClosed : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsClosed.
        [<Emit"$0.addListener('devtools-closed',$1)">]
        abstract addListenerDevtoolsClosed : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsClosed.
        [<Emit"$0.removeListener('devtools-closed',$1)">]
        abstract removeListenerDevtoolsClosed : listener:(unit -> unit) -> WebContents

        /// Emitted when DevTools is focused / opened.
        [<Emit"$0.on('devtools-focused',$1)">]
        abstract onDevtoolsFocused : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsFocused.
        [<Emit"$0.once('devtools-focused',$1)">]
        abstract onceDevtoolsFocused : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsFocused.
        [<Emit"$0.addListener('devtools-focused',$1)">]
        abstract addListenerDevtoolsFocused : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsFocused.
        [<Emit"$0.removeListener('devtools-focused',$1)">]
        abstract removeListenerDevtoolsFocused : listener:(unit -> unit) -> WebContents
        ...
        abstract onMediaStartedPlaying : listener:(unit -> unit) -> WebContents

        /// See onMediaStartedPlaying.
        [<Emit"$0.once('media-started-playing',$1)">]
        abstract onceMediaStartedPlaying : listener:(unit -> unit) -> WebContents

        /// See onMediaStartedPlaying.
        [<Emit"$0.addListener('media-started-playing',$1)">]
        abstract addListenerMediaStartedPlaying : listener:(unit -> unit) -> WebContents

        /// See onMediaStartedPlaying.
        [<Emit"$0.removeListener('media-started-playing',$1)">]
        abstract removeListenerMediaStartedPlaying : listener:(unit -> unit) -> WebContents

        /// Emitted when media is paused or done playing.
        [<Emit"$0.on('media-paused',$1)">]
        abstract onMediaPaused : listener:(unit -> unit) -> WebContents

        /// See onMediaPaused.
        [<Emit"$0.once('media-paused',$1)">]
        abstract onceMediaPaused : listener:(unit -> unit) -> WebContents

        /// See onMediaPaused.
        [<Emit"$0.addListener('media-paused',$1)">]
        abstract addListenerMediaPaused : listener:(unit -> unit) -> WebContents

        /// See onMediaPaused.
        [<Emit"$0.removeListener('media-paused',$1)">]
        abstract removeListenerMediaPaused : listener:(unit -> unit) -> WebContents
        ...
        abstract onCursorChanged : listener:(Event -> CursorType -> NativeImage option -> float option -> Size option -> Point option -> unit)
         -> WebContents

        /// See onCursorChanged.
        [<Emit"$0.once('cursor-changed',$1)">]
        abstract onceCursorChanged : listener:(Event -> CursorType -> NativeImage option -> float option -> Size option -> Point option -> unit)
         -> WebContents

        /// See onCursorChanged.
        [<Emit"$0.addListener('cursor-changed',$1)">]
        abstract addListenerCursorChanged : listener:(Event -> CursorType -> NativeImage option option -> float option -> Size option -> Point -> unit)
         -> WebContents

        /// See onCursorChanged.
        [<Emit"$0.removeListener('cursor-changed',$1)">]
        abstract removeListenerCursorChanged : listener:(Event -> CursorType -> NativeImage option -> float option -> Size option -> Point option -> unit)
         -> WebContents
        ...
        abstract onDevtoolsReloadPage : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsReloadPage.
        [<Emit"$0.once('devtools-reload-page',$1)">]
        abstract onceDevtoolsReloadPage : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsReloadPage.
        [<Emit"$0.addListener('devtools-reload-page',$1)">]
        abstract addListenerDevtoolsReloadPage : listener:(unit -> unit) -> WebContents

        /// See onDevtoolsReloadPage.
        [<Emit"$0.removeListener('devtools-reload-page',$1)">]
        abstract removeListenerDevtoolsReloadPage : listener:(unit -> unit) -> WebContents
    ...
    type WebFrame =
        ...
        abstract executeJavaScriptInIsolatedWorld : worldId:int * scripts:WebSource [] * ?userGesture:bool
         -> Promise<obj option>
